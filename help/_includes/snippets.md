...
## Nota de configuração do Commerce no cache da nuvem com referência {#cloud-cache-config}

>[!NOTE]
>
>Para projetos do Adobe Commerce na nuvem, consulte [Práticas recomendadas para a configuração do serviço Redis e Valkey](https://experienceleague.adobe.com/en/docs/commerce-operations/implementation-playbook/best-practices/planning/redis-valkey-service-configuration) para obter instruções sobre a configuração do cache. O cache Redis não é suportado para o Adobe Commerce 2.4.9, ou versões de patch posteriores a 2.4.5-p16, 2.4.6-p14, 2.4.7-p9 e até as linhas de versão 2.4.8-p5. Use Valkey para configuração de cache, onde Redis não é suportado. Consulte [Requisitos do sistema](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/system-requirements) para obter os serviços de cache com suporte por versão.

## Nota de configuração do Commerce no Cloud Varnish com referência {#varnish-config-cloud}

>[!NOTE]
>
>Se seu projeto do Commerce for implantado na nuvem, o armazenamento em cache de página inteira usará [Fastly](https://experienceleague.adobe.com/en/docs/commerce-cloud-service/user-guide/cdn/fastly) em vez de Varnish. Os tópicos desta seção se aplicam somente a instalações locais.
...
>[!IMPORTANT]
>
>O recurso de banco de dados dividido foi descontinuado na versão 2.4.2 do Adobe Commerce. Consulte [Reverter de um banco de dados dividido para um único banco de dados](/help/configuration/storage/revert-split-database.md).
...
>[!NOTE]
>
>A partir do Adobe Commerce 2.4.9, a Valkey substituiu oficialmente o Redis nas ferramentas CLI. Para **versões 2.4.8 e anteriores**, use os [comandos Redis CLI](/help/configuration/cache/config-redis.md#set-up-redis-configuration) equivalentes.
