...
<table style="table-layout:auto">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          8.0.mysql_aurora.3.09 ou mais recente disponível
      </td>
      <td>
          8.0.mysql_aurora.3.09 ou mais recente disponível
      </td>
      <td>
          8.0.mysql_aurora.3.08 ou mais recente disponível
      </td>
      <td>
          8.0.mysql_aurora.3.08 ou mais recente disponível
      </td>
    ...
    <tr>
      ...
      <td>
          ElastiCache versão 7.1 para Redis OSS (avançado). O Valkey 8 está disponível.
      </td>
      <td>
          ElastiCache versão 7.1 para Redis OSS (avançado)
      </td>
      <td>
          ElastiCache versão 7.1 para Redis OSS (avançado)
      </td>
    ...
    <tr>
      ...
      <td>
          2.19 ou mais recente disponível
      </td>
      <td>
          2.19 ou mais recente disponível
      </td>
...
<table style="table-layout:auto">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          2.17 ou mais recente disponível
      </td>
      <td>
          2.19 ou mais recente disponível
      </td>
