...
Saiba mais: [Adição de usuários](https://experienceleague.adobe.com/docs/commerce-admin/systems/user-accounts/permissions-users-all.html)

_Atributos de termo:_

* _Campo: software de comércio_
* _Sinônimos: administrador, superusuário_
* _Termos relacionados: commerce admin_
...
* _Campo: software de comércio_
* _Sinônimos: Administração, Painel de administração, back-end, Interface de administração, Interface do administrador_
...
* _Campo: software de comércio_
* _Termos relacionados: componente de comércio, loja_
...
Para [Inventory management](https://experienceleague.adobe.com/docs/commerce-admin/inventory/sources/sources-manage.html) e [Order Management](https://omsdocs.magento.com/getting-started/terminology/), esta loja é uma fonte para rastrear quantidades de produtos, pedidos de remessa e entrega na loja.
...
Saiba mais: [Operações em massa do DevDocs](https://developer.adobe.com/commerce/php/development/components/message-queues/bulk-operations/)
...
* _Termos relacionados: extensão, extensão agrupada do fornecedor_
...
* _Campo: negócios, design, ordem, produto, programação_

### variáveis de nuvem

_substantivo_

As variáveis de nuvem são variáveis de ambiente específicas do Adobe Commerce na infraestrutura em nuvem e usam o **`MAGENTO_CLOUD`** prefixo.
...
Uma variante especial de [bloco](https://experienceleague.adobe.com/docs/commerce-admin/content-design/elements/blocks/blocks.html) que só podem ser criadas no Admin e não podem ser referenciadas por meio de arquivos de layout.

_Atributos de termo:_

* _Campo: software de comércio_
* _Termos relacionados: block, static block_
...
* _Termos relacionados: componente de interface_
...
* _Campo: programação_
* _Termos relacionados: content delivery network, url_
...
* _Campo: software de comércio_
* _Termos relacionados: component, module, package_
...
* _Termos relacionados: backend, storefront, cache front-end_
...
* _Campo: software de design e comércio_
...
Saiba mais: [Obter suas chaves de autenticação](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/prerequisites/authentication-keys.html)
...
[Configurar a marcação](https://experienceleague.adobe.com/docs/commerce-admin/catalog/products/settings/settings-advanced-custom-options.html)ou markdown de um produto por meio de opções personalizáveis do produto.
...
[OMS](https://omsdocs.magento.com) é a oferta do Sistema de gerenciamento de pedidos Adobe.
...
Saiba mais: [Introdução ao OMS](https://omsdocs.magento.com/en/getting-started/), [Site da Documentação do OMS](https://omsdocs.magento.com/en/)
...
* _Termos relacionados: order management_
...
* _Campo: segurança_
* _Termos relacionados: Web application firewall_
...
* _Campo: programação_
* _Termos relacionados: php, web api_
...
* _Campo: software de comércio_
* _Termos relacionados: cms block, block_
...
* _Campo: design_
* _Termos relacionados: dynamic content_
...
* Transferência de elementos da interface do usuário de Admin do HTML+JavaScript para um sistema de widget personalizado &quot;JavaScript puro&quot;
...
* _Campo: programação_
* _Termos relacionados: JavaScript, layout, componente, construtor de página_

### PARA CIMA

_substantivo_

[PWA Studio](https://github.com/magento/pwa-studio) usos [PARA CIMA](https://developer.adobe.com/commerce/pwa-studio/guides/packages/upward/) em desenvolvimento.
...
* _Campo: design, software de comércio, programação_
...
Os tipos virtuais só podem ser referenciados por substituições de argumento em um `<type>` elemento em arquivos di.xml, nunca no código-fonte.
...
* _Termos relacionados: loja, exibição de loja_
