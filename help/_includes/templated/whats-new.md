...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Adicionado o <code class="language-plaintext highlighter-rouge">commerce.eventing.event.publish</code> consumidor da fila de mensagens para o <a href="https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/message-queues/consumers.html">tabela de referência</a>.</p>
</td>
      <td>técnico</td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Adicionado <code class="language-plaintext highlighter-rouge">catalog/seo/generate_category_product_rewrites</code> para <a href="https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/paths/config-reference-catalog.html">referência do caminho de configuração do catálogo</a>.</p>
</td>
      <td>técnico</td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Publicado <a href="https://experienceleague.adobe.com/docs/commerce-operations/tools/quality-patches-tool/release-notes.html">notas de versão</a> para a versão do pacote QPT (Quality Patches Tool) 1.1.29.</p>
</td>
      <td>major-update</td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Foram adicionadas informações sobre novos <a href="https://experienceleague.adobe.com/docs/commerce-operations/release/notes/adobe-commerce/2-4-6.html#known-issue">problema conhecido</a> para Adobe Commerce 2.4.6.</p>
</td>
      <td>major-update</td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Atualizado <a href="https://experienceleague.adobe.com/docs/commerce-operations/release/versions.html&lt;br/&gt;">Versões lançadas</a>.</p>
</td>
      <td>técnico</td>
