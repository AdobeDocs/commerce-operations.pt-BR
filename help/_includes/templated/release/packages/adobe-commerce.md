...
A documentação de referência a seguir é gerada a partir do `composer.lock` e abrange os pacotes necessários incluídos no Adobe Commerce 2.4.6-beta2.

## Dependências

`magento/product-enterprise-edition 2.4.6-beta2` tem as seguintes dependências:
...
<table>
  ...
  <tr>
    <td>
      <a href="https://github.com/twigphp/Twig.git">galho galho</a>
    </td>
    <td>biblioteca</td>
    <td>Twig, a linguagem de modelo flexível, rápida e segura para PHP</td>
  </tr>
  </tbody>
</table>
