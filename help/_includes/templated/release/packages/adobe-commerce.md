...
A documentação de referência a seguir é gerada a partir do `composer.lock` e abrange os pacotes necessários incluídos no Adobe Commerce 2.4.6.

## Dependências

`magento/product-enterprise-edition 2.4.6` tem as seguintes dependências:
