...
A documentação de referência a seguir é gerada a partir do arquivo `composer.lock` e abrange os pacotes necessários incluídos no Adobe Commerce 2.4.9.

## Dependências

`magento/product-enterprise-edition 2.4.9` tem as seguintes dependências:

- adobe-commerce/adobe-ims-metappackage: ~2.2.4
- adobe-commerce/extensions-metappackage: ^2.0.3
- colinmollenhour/arquivo-back-end-cache: ^1.4
- colinmollenhour/cache-backend-redis: ^1,16
- colinmollenhour/credis: ^1.15
- colinmollenhour/php-redis-session-abstract: ^2,0
- compositor/compositor: ^2.2
...
- [magento/module-aws-s3-vale-presente-importação-exportação](https://developer.adobe.com/commerce/php/module-reference/module-aws-s3-gift-card-import-export): 100.4.6
...
- [magento/module-checkout-address-search-dom-registry](https://developer.adobe.com/commerce/php/module-reference/module-checkout-address-search-gift-registry): 100.4.5
...
- [magento/module-deferred-total-calculation](https://developer.adobe.com/commerce/php/module-reference/module-deferred-total-calculating): 100.4.4
...
- [magento/module-vale-presente](https://developer.adobe.com/commerce/php/module-reference/module-gift-card): 101.3.9
- [magento/module-vale-presente-conta](https://developer.adobe.com/commerce/php/module-reference/module-gift-card-account): 101.2.9
- [magento/module-vale-presente-card-account-graph-ql](https://developer.adobe.com/commerce/php/module-reference/module-gift-card-account-graph-ql): 100.4.7
- [magento/module-dom-card-graph-ql](https://developer.adobe.com/commerce/php/module-reference/module-gift-card-graph-ql): 100.4.9
- [magento/module-vale-presente-import-export](https://developer.adobe.com/commerce/php/module-reference/module-gift-card-import-export): 100.4.6
- [magento/module-present-card-staging](https://developer.adobe.com/commerce/php/module-reference/module-gift-card-staging): 100.4.6
- [magento/module-present-message-staging](https://developer.adobe.com/commerce/php/module-reference/module-gift-message-staging): 100.4.6
- [magento/module-present-registry](https://developer.adobe.com/commerce/php/module-reference/module-gift-registry): 101.2.9
- [magento/module-present-registry-graph-ql](https://developer.adobe.com/commerce/php/module-reference/module-gift-registry-graph-ql): 100.4.5
- [magento/module-present-wrapping](https://developer.adobe.com/commerce/php/module-reference/module-gift-wrapping): 101.2.8
- [magento/module-present-wrapping-graph-ql](https://developer.adobe.com/commerce/php/module-reference/module-gift-wrapping-graph-ql): 100.4.6
- [magento/module-present-wrapping-staging](https://developer.adobe.com/commerce/php/module-reference/module-gift-wrapping-staging): 100.4.6
- [magento/module-google-otimizer-staging](https://developer.adobe.com/commerce/php/module-reference/module-google-optimizer-staging): 100.4.6
...
- [magento/module-convite](https://developer.adobe.com/commerce/php/module-reference/module-invitation): 100.4.8
...
- [magento/module-quote-present-card-options](https://developer.adobe.com/commerce/php/module-reference/module-quote-gift-card-options): 100.4.6
...
- [magento/module-recompensa](https://developer.adobe.com/commerce/php/module-reference/module-reward): 101.2.9
- [magento/module-reforço-graph-ql](https://developer.adobe.com/commerce/php/module-reference/module-reward-graph-ql): 100.4.8
- [magento/module-reforço-staging](https://developer.adobe.com/commerce/php/module-reference/module-reward-staging): 100.4.6
...
- [magento/module-wee-staging](https://developer.adobe.com/commerce/php/module-reference/module-weee-staging): 100.4.6
- [magento/module-wishlist-vale-presente](https://developer.adobe.com/commerce/php/module-reference/module-wishlist-gift-card): 100.4.5
- [magento/module-wishlist-dom-card-graph-ql](https://developer.adobe.com/commerce/php/module-reference/module-wishlist-gift-card-graph-ql): 100.4.5
...
<table>
  ...
  <tr>
    ...
    <td>Biblioteca</td>
    <td>Uma biblioteca para analisar, formatar, armazenar e validar números de telefone internacionais, uma porta PHP do libphonenumber da Google.</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    <td>Biblioteca</td>
    <td>suporte a stomp para PHP</td>
  </tr>
  <tr>
    <td>
...
<table>
  ...
  <tr>
    ...
    <td>Biblioteca</td>
    <td>Biblioteca de números de telefone</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    <td>Biblioteca</td>
    <td>Funções locais requeridas por libphonenumber-for-php</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    <td>Biblioteca</td>
    <td>Um cliente Redis/Valkey flexível e completo para PHP.</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    <td>Biblioteca</td>
    <td>Fornece implementações estendidas de PSR-6, PSR-16 (e tags)</td>
  </tr>
  <tr>
    <td>
      <a href="https://github.com/symfony/cache-contracts">symfony/cache-contracts</a>
    </td>
    <td>Biblioteca</td>
    <td>Abstrações genéricas relacionadas ao armazenamento em cache</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    <td>Biblioteca</td>
    <td>Symfony polyfill reforçando alguns recursos do PHP 8.4+ para versões mais baixas do PHP</td>
  </tr>
  <tr>
    <td>
    ...
    <td>Biblioteca</td>
    <td>Symfony polyfill reforçando alguns recursos do PHP 8.5+ para versões mais baixas do PHP</td>
  </tr>
  <tr>
    <td>
