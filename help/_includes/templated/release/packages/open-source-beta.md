...
A documentação de referência a seguir é gerada a partir do `composer.lock` e abrange os pacotes necessários incluídos no Magento Open Source 2.4.7-beta1.

## Dependências

`magento/product-community-edition 2.4.7-beta1` tem as seguintes dependências:
