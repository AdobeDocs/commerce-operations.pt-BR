...
A documentação de referência a seguir é gerada a partir do `composer.lock` e abrange os pacotes necessários incluídos no Magento Open Source 2.4.5.

## Dependências

`magento/product-community-edition 2.4.5` O tem as seguintes dependências:
