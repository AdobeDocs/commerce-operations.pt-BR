...
A infraestrutura em nuvem do Adobe Commerce usa o Composer para gerenciar pacotes PHP.
...
A documentação de referência a seguir é gerada a partir do `composer.lock` e abrange os pacotes necessários incluídos no Adobe Commerce na infraestrutura de nuvem 2.4.4.

## Dependências

`magento/magento-cloud-metapackage 2.4.4` O tem as seguintes dependências:
...
<table>
  ...
  <tr>
    <td>
      <a href="https://github.com/fastly/fastly-magento2.git">jejum/magento2</a>
    </td>
    <td>magento2-module</td>
    <td>Módulo de CDN rápido para Magento 2.3.x | 2.4.x</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    <td>biblioteca</td>
    <td>fornece funcionalidade para consumir feeds RSS e Atom</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    <td>biblioteca</td>
    <td>Crie números pseudo-aleatórios criptograficamente seguros e gerencie números inteiros grandes</td>
  </tr>
  <tr>
    <td>
...
<table>
  ...
  <tr>
    <td>
      <a href="https://github.com/FriendsOfPHP/proxy-manager-lts.git">Frisofphp/proxy-manager-lts</a>
    </td>
    <td>biblioteca</td>
    <td>Adição de suporte para uma maior variedade de versões PHP para ocramius/proxy-manager</td>
  </tr>
  <tr>
    <td>
    ...
    <td>biblioteca</td>
    <td>Uma implementação de php para enviar mensagens de log para um back-end compatível com GELF, como o Graylog2.</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    <td>
      <a href="https://github.com/illuminate/collections.git">iluminar/recolher</a>
    </td>
    <td>biblioteca</td>
    <td>O pacote Iluminar Coleções.</td>
  </tr>
  <tr>
    <td>
    ...
    <td>biblioteca</td>
    <td>O pacote Iluminate Config .</td>
  </tr>
  <tr>
    <td>
    ...
    <td>biblioteca</td>
    <td>O pacote Iluminate Contracts.</td>
  </tr>
  <tr>
    <td>
      <a href="https://github.com/illuminate/macroable.git">iluminar/macroável</a>
    </td>
    <td>biblioteca</td>
    <td>O pacote Iluminate Macroable.</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    <td>
      <a href="https://github.com/briannesbitt/Carbon.git">nanbot/carbono</a>
    </td>
    <td>biblioteca</td>
  ...
  <tr>
    <td>
      <a href="https://github.com/php-fig/simple-cache.git">vqprd/cache simples</a>
    </td>
    <td>biblioteca</td>
  ...
  <tr>
    ...
    <td>ligação simbólica</td>
    <td>Fornece integração para o ProxyManager com vários componentes de Fontes</td>
  </tr>
  <tr>
    <td>
      <a href="https://github.com/symfony/serializer.git">sifonia/serializador</a>
    </td>
    <td>biblioteca</td>
    <td>Trata a serialização e desserialização de estruturas de dados, incluindo gráficos de objetos, em estruturas de matriz ou outros formatos, como XML e JSON.</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    <td>
      <a href="https://github.com/symfony/translation.git">sifonia/tradução</a>
    </td>
    <td>biblioteca</td>
  ...
  <tr>
    <td>
      <a href="https://github.com/symfony/translation-contracts.git">sifonia/contratos de tradução</a>
    </td>
    <td>biblioteca</td>
  ...
  <tr>
    <td>
      <a href="https://github.com/symfony/yaml.git">sifonia/yaml</a>
    </td>
    <td>biblioteca</td>
  ...
  <tr>
    ...
    <td>biblioteca</td>
    <td>Uma implementação PHP extremamente rápida de handlebars ( http://handlebarsjs.com/ ) e mustache ( http://mustache.github.io/ ).</td>
  </tr>
  </tbody>
</table>
