...
---
# Adobe Commerce corrigiu problemas (v2.4.9-beta1)

## Correção de problemas na v2.4.9-beta1

Corrigimos 560 problemas no código principal do Adobe Commerce 2.4.9-beta1. Um subconjunto dos problemas corrigidos incluídos nesta versão está descrito abaixo.
