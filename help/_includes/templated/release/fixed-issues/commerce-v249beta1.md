...
Antes da correção, os códigos de voucher não podiam ser usados corretamente no modo de visualização de preparo. Agora, após a correção, os códigos do voucher são aplicados corretamente na página de check-out.
