...
---
# problemas corrigidos de Magento Open Source (v2.4.8-beta1)

## Problemas corrigidos

Corrigimos 221 problemas no código principal Magento Open Source 2.4.8. Um subconjunto dos problemas corrigidos incluídos nesta versão está descrito abaixo.
...
* _AC-9922_: Erro de Google Analytics CSP https://region1.analytics.google.com
   * _Observação de correção_: o sistema agora permite corretamente conexões com &#39;https://region1.analytics.google.com&#39; quando o Google Analytics está habilitado, impedindo erros de Política de Segurança de Conteúdo (CSP). Anteriormente, ativar o Google Analytics e visualizar o site da UE resultava em erros de console do CSP devido a uma recusa de conexão com &quot;https://region1.analytics.google.com&#39;&quot;.
...
* _AC-9712_: diferença em menos compilação entre php e biblioteca nodejs (grunt) com expressões `calc` complicadas
   * _Nota de correção_: corrigir a diferença na compilação menor entre php e biblioteca nodejs (grunt)
...
* _AC-8358_: [Problema] Remover marca `@author` proibida
   * _Observação de correção_: o sistema agora segue os padrões de codificação, removendo a marca `@author` proibida de determinados módulos, melhorando a qualidade e a consistência do código. Anteriormente, a presença dessa tag em alguns módulos violava os padrões de codificação estabelecidos.
   * _Problema do GitHub_: <https://github.com/magento/magento2/issues/37264>
   * _Contribuição de código do GitHub_: <https://github.com/magento/magento2/pull/37014>
* _AC-8360_: [Problema] Remover marca `@author` proibida
   * _Observação de correção_: o sistema agora segue os padrões de codificação, removendo a marca `@author` proibida de determinados módulos, melhorando a qualidade geral do código. Anteriormente, a presença dessa tag em alguns módulos violava os padrões de codificação estabelecidos.
   * _Problema do GitHub_: <https://github.com/magento/magento2/issues/37261>
   * _Contribuição de código do GitHub_: <https://github.com/magento/magento2/pull/37011>
* _AC-8361_: [Problema] Remover marca `@author` proibida
   * _Observação de correção_: o sistema agora segue os padrões de codificação, removendo a marca `@author` proibida de determinados módulos, garantindo um código mais limpo e padronizado. Anteriormente, a presença dessa tag em alguns módulos violava os padrões de codificação estabelecidos.
   * _Problema do GitHub_: <https://github.com/magento/magento2/issues/37260>
   * _Contribuição de código do GitHub_: <https://github.com/magento/magento2/pull/37010>
* _AC-8400_: [Problema] Remover marca `@author` proibida
   * _Observação de correção_: o sistema agora segue os padrões de codificação, removendo a marca `@author` proibida de determinados módulos, melhorando a qualidade geral do código. Anteriormente, a presença dessa tag em alguns módulos violava os padrões de codificação estabelecidos.
   * _Problema do GitHub_: <https://github.com/magento/magento2/issues/37254>
   * _Contribuição de código do GitHub_: <https://github.com/magento/magento2/pull/37004>
...
* _ACP2E-3002_: [CLOUD] Não Pode Desabilitar o Envio de Emails da Interface do Administrador, como mostra o Dev Docs
   ...
   * _Contribuição de código do GitHub_: <https://github.com/magento/magento2/commit/c8931218>
* _AC-12462_: não é possível alterar o status personalizado intermediário no administrador usando o formulário adicionar comentário
   * _Observação de correção_: o sistema agora atualiza corretamente o status do pedido para &quot;Pronto para retirada&quot; quando alterado do formulário &quot;Adicionar comentário&quot; no painel de administração, garantindo um rastreamento preciso do progresso do pedido. Anteriormente, o status do pedido permanecia como &quot;Enviado&quot; mesmo após a tentativa de alterá-lo para &quot;Pronto para recebimento&quot; por meio do formulário &quot;Adicionar comentário&quot;.
   * _Problema do GitHub_: <https://github.com/magento/magento2/issues/38917>
   * _Contribuição de código do GitHub_: <https://github.com/magento/magento2/pull/38923>
