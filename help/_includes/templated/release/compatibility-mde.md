...
**Compatível** - versão que confirma a compatibilidade com ou , mas não é compatível.

**Não suportado** - versão que não é compatível com uma versão do Commerce ou Magento.
