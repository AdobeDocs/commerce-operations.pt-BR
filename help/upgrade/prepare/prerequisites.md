...
Você deve instalar e configurar o Elasticsearch 7.6 ou superior ou o OpenSearch 1.2 antes de atualizar para 2.4.0. O Adobe não é mais compatível com o Elasticsearch 2.x, 5.x e 6.x.
