...
Usamos [Compositor](https://getcomposer.org/) para gerenciar componentes Adobe Commerce e Magento Open Source e suas dependências. Utilização do Composer para obter o Adobe Commerce e o Magento Open Source [metapackage](https://glossary.magento.com/metapackage) oferece as seguintes vantagens:
