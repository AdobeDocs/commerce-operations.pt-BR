...
description: Saiba como desinstalar temas do Adobe Commerce da linha de comando, incluindo pacotes do Composer, remoção de código e backups, antes de fazer alterações.
