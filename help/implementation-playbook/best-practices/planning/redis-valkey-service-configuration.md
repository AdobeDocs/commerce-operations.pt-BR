...
Para a Valkey com a implementação de cache herdada, use:
...
Para o Valkey com a implementação moderna do cache L2 do Symfony, consulte [Configurar cache L2 do Symfony](#configure-symfony-l2-cache).
