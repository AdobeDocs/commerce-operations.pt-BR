...
- [Segurança para o administrador do Commerce](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/security/security-admin)

- [Conexões SSH seguras](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/project/multi-factor-authentication) (infraestrutura em nuvem)
...
- [Definir configurações de segurança avançadas](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/security/security-admin) — Adicione uma chave secreta a URLs, exija senhas que diferenciam maiúsculas de minúsculas e limite a duração da sessão do Administrador, o tempo de vida da senha e as tentativas de logon. Para maior segurança, configure o tempo de inatividade do teclado antes que a sessão atual expire e exija que o nome de usuário e a senha diferenciem maiúsculas de minúsculas.

- [Habilite o reCAPTCHA](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/security/captcha/security-google-recaptcha) para proteger o Administrador contra ataques automatizados de força bruta.

- Siga o princípio do privilégio mínimo ao atribuir [Permissões de administrador](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/user-accounts/permissions) a funções e funções para contas de usuário administrador.
...
Use o [serviço de Verificação de Segurança da Commerce](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/security/security-scan) para monitorar todos os sites da Adobe Commerce quanto a riscos de segurança e malware conhecidos, e inscreva-se para receber atualizações de patches e notificações de segurança.
...
- [Gerenciamento de configuração de loja para o Adobe Commerce na infraestrutura em nuvem](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/configure-store/store-settings)
...
As instalações do Adobe Commerce implantadas na infraestrutura em nuvem podem usar os serviços WAF integrados disponíveis com a [integração do Fastly services](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/cdn/fastly)
