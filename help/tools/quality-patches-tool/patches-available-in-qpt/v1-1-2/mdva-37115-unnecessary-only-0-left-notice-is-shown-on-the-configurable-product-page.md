...
O patch MDVA-37115 resolve o problema em que o aviso *Only 0 left* desnecessário é mostrado na página do produto configurável. Este patch está disponível quando a [Ferramenta de Patches de Qualidade (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.2 está instalada. A ID do patch é MDVA-37115. Observe que o problema foi corrigido no Adobe Commerce 2.4.3.
