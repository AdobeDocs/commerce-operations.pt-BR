...
O patch ACSD-57394 corrige o problema em que os produtos são classificados incorretamente ao usar vários atributos de classificação em [!DNL GraphQL]. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.48 está instalado. A ID do patch é ACSD-57394. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.5.0.
