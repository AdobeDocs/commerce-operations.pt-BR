...
O patch ACSD-59925 corrige o problema em que os itens em [!UICONTROL Media Gallery] não são classificados por posição, resultando em uma ordem de exibição incorreta. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/pt-br/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.52 está instalado. A ID do patch é ACSD-59925. Observe que esse problema está programado para ser corrigido no Adobe Commerce 2.4.8.
