---
title: 'MDVA-41215: Os usuários recebem o erro 500 após definir o cookie "mage-messages"'
description: O patch MDVA-41215 corrige o problema em que os usuários obtêm o erro 500 após definir o cookie "mage-messages" se ele já existir, mas não há novas mensagens. Este patch está disponível quando a [Ferramenta de correções de qualidade (QPT)](https://experienceleague.adobe.com/pt-br/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.8 está instalada. A ID do patch é MDVA-41215. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.4.
...
# MDVA-41215: Os usuários recebem o erro 500 após definir o cookie &quot;mage-messages&quot;

O patch MDVA-41215 corrige o problema em que os usuários obtêm o erro 500 após definir o cookie &quot;mage-messages&quot; se ele já existir, mas não há novas mensagens. Este patch está disponível quando a [Ferramenta de Patches de Qualidade (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.8 está instalada. A ID do patch é MDVA-41215. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.4.
...
Os usuários obtêm o erro 500 após definir o cookie &quot;mage-messages&quot; se ele já existe, mas não há novas mensagens.

<u>Etapas a serem reproduzidas</u>:

1. Ir para **../customer/account/login**.
1. Abra a guia Rede nas ferramentas de desenvolvimento do navegador (verifique se a opção Preservar log está marcada).
1. Preencha o formulário com valores inválidos (o logon deve falhar).
1. Clique em **Enviar**.
1. Copie como cURL a primeira solicitação da guia de rede e procure os valores PHPSESSID e form_key.
1. Substitua os valores PHPSESSID e form_key na solicitação de cURL atualizada e envie-a.
...
Os usuários obtêm `HTTP/1.1 200 OK`

<u>Resultados reais</u>:

Os usuários obtêm `HTTP/1.1 500 Internal Server Error`
