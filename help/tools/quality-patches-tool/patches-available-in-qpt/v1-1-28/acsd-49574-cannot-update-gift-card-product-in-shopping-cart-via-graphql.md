...
O patch ACSD-49574 corrige o problema em que um produto de cartão-presente não pode ser atualizado no carrinho de compras via GraphQL. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/pt-br/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.28 está instalado. A ID do patch é ACSD-49574. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.7.
