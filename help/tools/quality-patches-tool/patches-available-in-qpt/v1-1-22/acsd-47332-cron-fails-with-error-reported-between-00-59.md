...
O patch ACSD-47332 corrige o problema em que o cron falha com um erro que é relatado somente quando está em execução entre 00:00 e 00:59 UTC. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.22 está instalado. A ID do patch é ACSD-47332. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.6.
