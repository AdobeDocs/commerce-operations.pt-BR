...
Consulte [Commerce > Ferramentas > Uso](/help/tools/quality-patches-tool/usage.md) em nossa documentação do desenvolvedor para obter detalhes sobre como instalar e usar o QPT para aplicar e reverter patches.
