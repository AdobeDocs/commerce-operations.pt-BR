...
O patch ACSD-49960 corrige o problema em que a filtragem por data não funciona para a grade de pedidos do cliente. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.29 está instalado. A ID do patch é ACSD-49960. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.7.
