...
O patch ACSD-59786 corrige o problema em que uma consulta do GraphQL retorna um erro ao buscar um `quote_id` para uma cotação expirada. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.51 está instalado. A ID do patch é ACSD-59786. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.8.
