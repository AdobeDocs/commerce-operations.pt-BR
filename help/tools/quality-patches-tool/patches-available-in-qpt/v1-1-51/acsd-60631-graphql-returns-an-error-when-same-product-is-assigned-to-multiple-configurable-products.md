---
title: 'ACSD-60631: o query do GraphQL retorna um erro quando o mesmo produto é atribuído a vários produtos configuráveis'
...
O patch ACSD-60631 corrige o problema em que um query do GraphQL retorna um erro quando o mesmo produto é atribuído a vários produtos configuráveis. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.51 está instalado. A ID do patch é ACSD-60631. Observe que esse problema está programado para ser corrigido no Adobe Commerce 2.4.8.
