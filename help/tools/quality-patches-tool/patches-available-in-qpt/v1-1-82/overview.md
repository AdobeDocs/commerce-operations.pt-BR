...
1. **ACP2E-4748**: corrige o problema em que a expiração dos pontos de premiação é processada lentamente nas lojas com um histórico de pontos de premiação grande, causando atrasos na expiração dos pontos de premiação.
...
1. **ACP2E-4805**: corrige o problema em que as solicitações de API de check-out se tornam significativamente mais lentas para produtos configuráveis com muitos produtos derivados quando o primeiro produto derivado comercializável aparece atrasado na lista.
...
1. **ACP2E-4875**: corrige o problema em que a exibição de contas de clientes com catálogos de endereços grandes no Administrador faz logoff inesperado de usuários administradores.
