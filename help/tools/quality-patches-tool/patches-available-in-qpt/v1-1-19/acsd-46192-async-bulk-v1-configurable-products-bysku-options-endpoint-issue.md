...
>[!NOTE]
>
>O patch ACSD-46192 foi parcialmente descontinuado, pois esse problema é resolvido pelo patch de segurança obrigatório [APSB25-08](https://experienceleague.adobe.com/pt-br/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/security-update-available-for-adobe-commerce-apsb25-08).
...
1. Envie uma solicitação POST para `async/bulk/V1/configurable-products/bySku/`.
