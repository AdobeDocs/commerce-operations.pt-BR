...
O patch ACSD-48070 corrige o problema em que uma exceção é acionada ao editar uma atualização programada. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/en/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.35 está instalado. A ID do patch é ACSD-48070. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.7.
