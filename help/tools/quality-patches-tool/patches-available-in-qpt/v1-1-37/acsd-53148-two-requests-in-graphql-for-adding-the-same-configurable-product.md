...
O patch ACSD-53148 corrige o problema em que duas solicitações paralelas no GraphQL para adicionar o mesmo produto configurável ao carrinho resultaram em dois itens separados no carrinho com o mesmo SKU de produto. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.37 está instalado. A ID do patch é ACSD-53148. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.7.
