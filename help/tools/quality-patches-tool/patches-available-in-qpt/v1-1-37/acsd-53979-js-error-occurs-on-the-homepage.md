...
O patch ACSD-53979 corrige o problema em que ocorre um erro de JavaScript na página inicial se a mensagem de boas-vindas contiver aspas simples. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.37 está instalado. A ID do patch é ACSD-53979. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.7.
