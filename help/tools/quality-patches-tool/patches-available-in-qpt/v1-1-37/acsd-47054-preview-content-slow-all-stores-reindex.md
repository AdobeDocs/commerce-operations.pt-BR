...
O patch ACSD-47054 corrige o problema em que uma pré-visualização do preparo de conteúdo leva mais tempo para ser carregada quando há muitas lojas. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.37 está instalado. A ID do patch é ACSD-47054. Observe que o problema foi corrigido no Adobe Commerce 2.4.6.
