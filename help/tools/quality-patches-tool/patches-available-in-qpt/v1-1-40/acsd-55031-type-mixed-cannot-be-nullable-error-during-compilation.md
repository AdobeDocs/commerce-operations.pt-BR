...
O patch ACSD-55031 corrige o problema em que o erro `Type "mixed" cannot be nullable` é exibido durante a compilação após a instalação de uma extensão personalizada. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.40 está instalado. A ID do patch é ACSD-55031. Observe que o problema foi corrigido no Adobe Commerce 2.4.6.
