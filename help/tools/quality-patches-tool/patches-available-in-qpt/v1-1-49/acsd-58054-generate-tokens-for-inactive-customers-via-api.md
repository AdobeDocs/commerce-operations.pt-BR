...
O patch ACSD-58054 corrige o problema em que é possível gerar tokens de cliente para clientes inativos por meio da API. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/pt-br/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.49 está instalado. A ID do patch é ACSD-58054. Observe que o problema está programado para ser corrigido no B2B 1.5.1.
