...
O patch ACSD-57588 corrige o problema em que o envio de um pedido para vários endereços aciona um erro durante o processamento da ID da região. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.49 está instalado. A ID do patch é ACSD-57588. Observe que o problema foi corrigido no Adobe Commerce 2.4.7.
