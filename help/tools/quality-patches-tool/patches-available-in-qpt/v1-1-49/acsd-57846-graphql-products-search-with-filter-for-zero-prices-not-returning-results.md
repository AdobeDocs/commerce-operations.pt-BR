...
O patch ACSD-57846 corrige o problema em que filtrar produtos pelo preço de zero resulta em uma solicitação malformada para [!DNL OpenSearch] e não retorna resultados. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.49 está instalado. A ID do patch é ACSD-57846. Observe que o problema foi corrigido no Adobe Commerce 2.4.7.
