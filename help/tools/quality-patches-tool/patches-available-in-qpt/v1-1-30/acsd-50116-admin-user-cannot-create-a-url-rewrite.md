...
O patch ACSD-50116 corrige o problema em que um usuário administrador não consegue criar uma regravação de URL para as subcategorias de nível três ou inferior. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.30 está instalado. A ID do patch é ACSD-50116. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.7.
