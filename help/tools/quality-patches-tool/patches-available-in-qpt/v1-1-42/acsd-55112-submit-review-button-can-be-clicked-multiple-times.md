...
O patch ACSD-55112 corrige o problema em que o botão [!UICONTROL Submit Review] pode ser clicado várias vezes sem validação de [!DNL Google reCAPTCHA v3]. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.42 está instalado. A ID do patch é ACSD-55112. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.7.
