...
O patch ACSD-54890 corrige o problema em que `aggregate_sales_report_bestsellers_data` causa erros [!DNL MySQL] devido a `/tmpdisk` ficar sem espaço. Este patch está disponível quando o [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.42 está instalado. A ID do patch é ACSD-54890. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.7.
