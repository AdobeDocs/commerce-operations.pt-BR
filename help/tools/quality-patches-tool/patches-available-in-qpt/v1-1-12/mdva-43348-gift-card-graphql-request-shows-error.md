...
O patch MDVA-43348 corrige o problema em que a solicitação do GraphQL para o cartão-presente mostra um erro se `gift_card_options` contiver &quot;uid&quot;. Este patch está disponível quando a [Ferramenta de Patches de Qualidade (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.12 está instalada. A ID do patch é MDVA-43348. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.5.
