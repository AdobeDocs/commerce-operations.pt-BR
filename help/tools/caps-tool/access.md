...
* Eles podem conceder a função apropriada por meio do Cloud Console
...
[!DNL Patching Automation] está disponível como uma guia no painel [!DNL Site-Wide Analysis Tool]. Você o acessa pelo Painel de Administração acessando **Relatórios** > **Insights do Sistema** > **Ferramenta de Análise do Site** na barra lateral de Administração. Consulte [Como acessar a Ferramenta de Análise do Site](https://experienceleague.adobe.com/pt-br/docs/commerce-operations/tools/site-wide-analysis-tool/access) para obter os pré-requisitos e a configuração de permissões.
