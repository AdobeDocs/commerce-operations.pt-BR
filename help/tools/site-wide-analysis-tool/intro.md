...
- **[[!DNL Managed Alerts]](/help/tools/managed-alerts-for-adobe-commerce/managed-alerts-for-magento-commerce.md)** - Monitore as métricas principais (CPU, desempenho do aplicativo, disco, memória e integridade do banco de dados) e forneça etapas claras de solução de problemas para ajudar os comerciantes a se manterem à frente dos problemas e evitar tempo de inatividade.
