...
>[!NOTE]
>
>Para acessar a Ferramenta de análise do site (SWAT), os usuários devem ter as permissões necessárias no Adobe Commerce Admin. O acesso direto ao URL do SWAT, incluindo links marcados, não é suportado.
