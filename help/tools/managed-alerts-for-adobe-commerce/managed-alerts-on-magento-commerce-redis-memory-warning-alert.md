...
* Se o site estiver respondendo ou ficar totalmente sem resposta, coloque-o imediatamente no modo de manutenção. Para obter etapas, consulte [Habilitar ou desabilitar o modo de manutenção](/help/installation/tutorials/maintenance-mode.md) no Guia de Instalação do Commerce.
