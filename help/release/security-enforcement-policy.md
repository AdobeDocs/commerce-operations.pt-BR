...
Envolva o administrador de comércio eletrônico a seguir as etapas.
...
1. Entre no [Cloud Console](https://experienceleague.adobe.com/pt-br/docs/commerce-on-cloud/start/cloud-console).
...
Se um ambiente não atender aos requisitos de segurança pelas datas de imposição compartilhadas acima, a Adobe será forçada a tomar as medidas apropriadas para garantir a segurança da plataforma Adobe Commerce e de seus clientes. Isso inclui a suspensão do tráfego para a infraestrutura afetada e, como resultado, sua loja de eCommerce ficará offline.
...
## Recursos para lhe dar suporte com atualização ou migração
