...
Para obter as informações mais recentes sobre as correções de erros de segurança, consulte o [Boletim de Segurança de Adobe APSB21-64](https://helpx.adobe.com/security/products/magento/apsb21-64.html).
