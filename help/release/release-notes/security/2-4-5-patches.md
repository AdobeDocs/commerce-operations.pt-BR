...
#### Suporte ao Valkey 9.x LTS

O Adobe Commerce 2.4.5 agora é compatível com o Valkey 9.x LTS, fornecendo uma opção de back-end de cache de suporte de longo prazo, compatível com o Adobe Commerce na infraestrutura em nuvem.
