...
A versão de segurança 2.4.8-p5 do Adobe Commerce fornece correções de bugs de segurança para vulnerabilidades identificadas em versões anteriores da 2.4.8.
...
O Adobe Commerce 2.4.8 foi validado para compatibilidade com o MariaDB 11.8, mantendo o suporte para o MariaDB 11.4. Esta atualização aborda alterações de comportamento de SQL, atualizações padrão e descontinuações introduzidas no MariaDB 11.8 para manter a estabilidade da plataforma.

#### Suporte à versão secundária mais recente do OpenSearch 3

O Adobe Commerce 2.4.8 agora é compatível com a versão secundária mais recente do OpenSearch 3 no Adobe Commerce em infraestrutura em nuvem, Cloud Native e implantações locais. A compatibilidade com o OpenSearch 2 é mantida.

#### Suporte ao Valkey 8.1 LTS

O Adobe Commerce 2.4.8 agora é compatível com o Valkey 8.1 LTS, fornecendo uma opção de back-end de cache de suporte de longo prazo que é compatível com o Adobe Commerce na infraestrutura em nuvem.

#### Suporte ao RabbitMQ 4.2

O Adobe Commerce 2.4.8 agora é compatível com o RabbitMQ 4.2, que aborda a data de fim de suporte do RabbitMQ 4.1 programada para fevereiro de 2026. A compatibilidade com o Apache AtiveMQ Artemis é mantida, e o AtiveMQ permanece o serviço de fila de mensagens padrão para essa linha de versão somente de segurança.
...
Para lidar com a aposentadoria do Laminas MVC, a Adobe Commerce agora usa uma bifurcação de propriedade da Magento de `laminas-mvc` (publicada como `magento/magento-zf-mvc`). Essa bifurcação garante a correção contínua e a conformidade de segurança a longo prazo para o Adobe Commerce 2.4.8.

## 2.4.8-p4

A versão de segurança 2.4.8-p4 do Adobe Commerce fornece correções de bugs de segurança para vulnerabilidades identificadas em versões anteriores da 2.4.8.
...
O Adobe Commerce 2.4.8 foi atualizado para oferecer suporte ao Composer 2.9.x, permanecendo compatível com o Composer 2.2 LTS.
