---
title: Notas de versão do Adobe Commerce 2.4.7-beta3
description: Saiba mais sobre novos recursos, melhorias, correções de bugs e problemas conhecidos na versão 2.4.7-beta3 do Adobe Commerce.
...
# Notas de versão do Adobe Commerce 2.4.7-beta3
...
Adobe Commerce 2.4.7-beta3 apresenta suporte para PHP 8.3. Ele apresenta mais de 150 correções e melhorias de qualidade. As dependências do Core Composer e bibliotecas de terceiros foram atualizadas para as versões mais recentes disponíveis. Esta versão inclui melhorias significativas de desempenho, incluindo o carregamento mais rápido das páginas de listagem de produtos para produtos complexos com muitas opções.
...
## Ambiente de teste do Adobe Commerce 2.4.7-beta3

O Adobe Commerce 2.4.7-beta3 foi testado com as seguintes versões de componentes:
...
O Adobe Commerce 2.4.7-beta3 inclui as seguintes atualizações de plataforma:
...
O Adobe Commerce 2.4.7 ainda é compatível com o PHP 8.1 apenas para fins de atualização. O PHP 8.1 não é suportado e não é recomendado. O código principal Adobe Commerce 2.4.7-beta3, todas as extensões agrupadas e todas as extensões de propriedade do Adobe e serviços SaaS são compatíveis com o PHP 8.3. <!-- AC-9668 -->

* **Suporte ao RabbitMQ 3.11**. Esta versão é compatível com a versão mais recente do RabbitMQ 3.11. A compatibilidade permanece com o RabbitMQ 3.9, compatível até agosto de 2023, mas recomendamos usar o Adobe Commerce 2.4.7-beta3 somente com o RabbitMQ 3.11.

* **Composer 2.6.x**. A compatibilidade com o Composer 2.2.x permanece. <!-- AC-9663 -->

* **Suporte ao cache vernish 7.4**. Esta versão é compatível com a versão mais recente do Varnish Cache 7.4. A compatibilidade permanece com as versões 6.0.x e 7.2.x, mas recomendamos usar o Adobe Commerce 2.4.7-beta3 somente com o Varnish Cache versão 7.4 ou versão 6.0 LTS. <!-- AC-9662 -->
...
* **Vários cupons por suporte a pedido**. Os comerciantes agora podem configurar o número máximo de cupons que podem ser aplicados por pedido com o novo **[!UICONTROL Maximum number of coupons per order]** opção de configuração. Esse valor é definido como 1 por padrão. O suporte REST para esse recurso foi adicionado a esta versão e o suporte da GraphQL estará disponível em breve.
...
O Commerce 2.4.7-beta3 inclui os seguintes aprimoramentos de desempenho e escalabilidade do Commerce:
...
O Application Server para APIs do GraphQL permite que o Adobe Commerce mantenha o estado entre as solicitações de API do Commerce GraphQL e elimina a necessidade de bootstrapping, o que resulta em maior throughput, menor latência e uso eficiente de recursos para todas as APIs do GraphQL. Ao compartilhar o estado do aplicativo entre os processos, as solicitações da API do GraphQL tornam-se significativamente mais eficientes e as respostas da API do GraphQL são, em média, 30% mais rápidas. <!-- ACPT-27 -->

### Metappackage da extensão do Adobe Commerce

Esta versão apresenta o metapackage v2.0.0-beta3 da extensão do Adobe Commerce, que agrupa automaticamente extensões selecionadas do Adobe Commerce com esta versão principal. As versões dessas extensões incluídas neste metapackage são instaladas quando `composer update` O está em execução, simplificando o processo de atualização dessas extensões ao atualizar para a versão principal mais recente. Essas extensões mantêm programações de lançamento independentes.

O metapackage de extensão do Adobe Commerce para Adobe Commerce 2.4.7-beta3 inclui estas extensões:
...
Esta versão é fornecida com o B2B 1.4.2.
...
* Atualizações para REST e GraphQL
   ...
   * Adição de um endpoint para fornecer cobertura de API da Web para o recurso de cotação iniciada pelo vendedor introduzido nesta versão: `POST /V1/negotiableQuote/draft`. Consulte [Gerenciar cotações negociáveis](https://developer.adobe.com/commerce/webapi/rest/b2b/negotiable-manage/).
...
* Os dados do dispositivo para 3DS agora são verificados e exibidos no painel de controle do Braintree. A variável `collectDeviceData` agora o parâmetro é passado como `true` no `verifyCard` chame o 3DS. <!-- BUNDLE-3327 -->

* A página de configuração do Admin Payments agora inclui um link para a página de notas de versão e extensões Braintree. <!-- BUNDLE-3325 -->

* O SDK do Braintree foi atualizado para as versões mais recentes. <!-- BUNDLE-3323 -->
...
O Commerce 2.4.7 inclui recursos aprimorados de armazenamento em cache do GraphQL, suporte ao esquema do GraphQL para atributos personalizados, suporte para cancelamento de pedido headless e cache de resolvedor aprimorado.
...
* O suporte do GraphQL foi adicionado para operações principais para todos os métodos de pagamento, com exceção do Venmo. Os novos endpoints do GraphQL para serviços de pagamento estão descritos em [Check-out](https://developer.adobe.com/commerce/webapi/graphql/schema/checkout/). <!-- BUNDLE-3326 -->

* A compartimentação de cartão de crédito foi aprimorada para todos os métodos de pagamento, com exceção de Venmo. Agora, os compradores podem fazer o Vault ou salvar seus pagamentos da ACH e visualizá-los ou excluí-los da página da conta. Os comerciantes podem ativar e desativar os pagamentos com cofre da ACH junto ao Administrador. <!-- BUNDLE-3324 -->
...
Remova um único código de cupom de um carrinho:
...
Remova vários códigos de cupom de um carrinho:
...
Corrigimos centenas de problemas no código principal do Adobe Commerce 2.4.7-beta3. Um subconjunto dos problemas corrigidos incluídos nesta versão está descrito abaixo. As correções incluídas no Commerce 2.4.7-betas anterior também são descritas.
...
Você pode instalar o Adobe Commerce 2.4.7-beta3 usando [Compositor](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/composer.html).
