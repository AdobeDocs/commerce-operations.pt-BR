...
* [Parar check-out rápido](https://help.bolt.com/shoppers/about/)
...
* O esquema GraphQL de regra de ordem de compra oferece a capacidade de criar, editar e excluir regras de aprovação, bem como validar manualmente ordens de compra.
...
* A variável `addBundleProductsToCart` a consulta não adiciona mais produtos a uma cotação se uma opção de produto necessária não tiver valor. [GitHub-25676](https://github.com/magento/magento2/issues/25676)
