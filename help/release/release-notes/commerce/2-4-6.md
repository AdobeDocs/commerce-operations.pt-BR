...
* Adição de higienização de `DATE` e `DATETIME` valores em despejos de banco de dados para suporte do Adobe Commerce. Anteriormente, os campos do tipo datetime não eram limpos para tabelas de clientes/cotações/pedidos na tabela de backup do banco de dados.
