...
* Agora há suporte para [**Elasticsearch 7.9.x**](../../../installation/system-requirements.md). Embora seja recomendável executar o Elasticsearch 7.9.x, a versão 2.4.x permanece compatível com o Elasticsearch 7.4.x. <!-- MC-36867-->
...
* Adição de suporte para várias listas de desejos. Você pode usar o GraphQL para [criar](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-wishlist.html), [excluir](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-wishlist.html) e [renomear](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-wishlist.html) listas de desejos, bem como [mover](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-products-between-wishlists.html) ou [copiar](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-products-between-wishlists.html) itens entre elas. <!-- MC-32356-->

* Adição de suporte para autorizações de mercadoria retornada (RMA). Os compradores podem [solicitar um retorno](https://developer.adobe.com/commerce/webapi/graphql/mutations/request-return.html). Se o comerciante aceitar a solicitação, ele poderá executar tarefas como [adicionar um comentário](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-comment.html) e [adicionar informações de rastreamento](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-tracking.html). <!-- MC-34596-->

* Adição de suporte para os seguintes recursos B2B:
   * Empresas. Você pode adicionar [administradores](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company.html), [usuários](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-user.html), [funções](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-role.html) e [equipes](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-team.html) da empresa. <!-- MC-33861-->
   * Crédito da empresa. A [consulta de empresa](https://developer.adobe.com/commerce/webapi/graphql/queries/company.html) inclui detalhes sobre o histórico de crédito da empresa. <!-- MC-33862-->
   * Listas de requisições. Você pode [criar](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-requisition-list.html), [excluir](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list.html) e [atualizar](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-requisition-list.html) listas de requisições. O suporte também inclui a capacidade de [adicionar](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-requisition-list.html), [atualizar](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-products-in-wishlist.html), [excluir](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list-items.html), [copiar](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-items-between-requisition-lists.html) e [mover](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-items-between-requisition-lists.html) itens em uma lista de requisições, bem como de adicionar itens de lista de requisições [ao carrinho](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-requisition-list-items-to-cart.html). <!-- MC-34312-->

* Suporte adicionado para uniões na GraphQL. [GitHub-29425](https://github.com/magento/magento2/issues/29425) <!-- ENGCOM-8291 -->

* Adicionado suporte para [listas de comparação](https://developer.adobe.com/commerce/webapi/graphql/queries/compare-list.html). Os compradores podem [criar](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-compare-list.html) e [excluir](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-compare-list.html) listas de comparação e [adicionar](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-compare-list.html) e [remover](https://developer.adobe.com/commerce/webapi/graphql/mutations/remove-products-from-compare-list.html) itens para as listas de comparação. Além disso, os compradores que criam uma lista de comparação como convidado podem fazer logon como cliente e [manter](https://developer.adobe.com/commerce/webapi/graphql/mutations/assign-compare-list-to-customer.html) suas listas de comparação.

* Adicionada a mutação [`generateCustomerTokenAsAdmin`](https://developer.adobe.com/commerce/webapi/graphql/mutations/generate-customer-token-as-admin.html) e atualizado o objeto `Customer` para oferecer suporte à assistência à compra remota.
...
* O Page Builder não exige mais que todos os tipos de conteúdo sejam colocados em uma linha. O [estágio do Page Builder](https://experienceleague.adobe.com/en/docs/commerce-admin/page-builder/walkthrough/3-catalog-content#stage) agora está inicialmente em branco e oferece suporte à adição dos seguintes tipos de conteúdo diretamente no estágio: Linhas, Colunas, Guias, Código HTML, Blocos, Blocos dinâmicos.

* Margens e preenchimentos predefinidos não são mais necessários para tipos de conteúdo.

* O novo [seletor de visor](https://experienceleague.adobe.com/en/docs/commerce-admin/page-builder/walkthrough/3-catalog-content#viewports) móvel e o escopo de visor para valores de campo de formulário permitem que os usuários e desenvolvedores executem estas ações:
...
* [Pagamento do Amazon](https://marketplace.magento.com/amzn-amazon-pay-magento-2-module.html). O Amazon Pay foi descontinuado nesta versão e será removido no Magento 2.5.0. A versão 2.4.3 e superior conterá apenas atualizações para compatibilidade e correções para bugs principais.
...
* A capacidade de configurar uma instalação para usar um banco de dados dividido foi descontinuada nesta versão. Consulte a [Descontinuação da funcionalidade de banco de dados dividido na publicação do DevBlog do Adobe Commerce](https://community.magento.com/t5/Magento-DevBlog/Deprecation-of-Split-Database-in-Magento-Commerce/ba-p/465187).
...
* O aplicativo não lança mais um erro quando você tenta alterar o `backend-frontname` usando o contêiner `ssh` após instalar o Adobe Commerce. [GitHub-26762](https://github.com/magento/magento2/issues/26762)
...
* O aplicativo agora aplica a configuração **Logotipo para Exibição de Impressão do HTML** para PDF de fatura de vitrine conforme esperado. [GitHub-24730](https://github.com/magento/magento2/issues/24730)
...
* A classe `FlushCacheByTags` foi atualizada para usar plug-ins subsequentes em vez de plug-ins adjacentes. [GitHub-29558](https://github.com/magento/magento2/issues/29558)

<!-- ENGCOM-8358 -->

* `MessageValidator` não falha mais em matrizes de hash que não incluem um elemento `0`. [GitHub-30563](https://github.com/magento/magento2/issues/30563)
...
* O gerador de regravação de URL agora define os objetos de categoria `url_key`, `url_path` e `store_id` como valores de repositório padrão ao salvar regravações de URL de categoria para o escopo global. Anteriormente, ele salvou `url_key`, `url_path` e `store_id` com os valores da última ID de armazenamento processada. [GitHub-29585](https://github.com/magento/magento2/issues/29585)
...
* Adicionada a matriz `order_data` ausente às classes `EmailSender`. Isso alinha essas classes com a recomendação de Magento para usar variáveis escalares em vez de objetos nos modelos de email. [GitHub-29604](https://github.com/magento/magento2/issues/29604)
...
* Títulos e descrições significativos foram adicionados aos testes MFTF para os módulos `Company`, `CompanyCredit`, `CompanyPayment`, `CompanyShipping` e `ConfigurableSharedCatalog`. [GitHub-30164](https://github.com/magento/magento2/issues/30164)
...
* Os valores de cabeçalho que incluem URLs agora são analisados corretamente em `ApiFunctional TestFramewor`k. [GitHub-26425](https://github.com/magento/magento2/issues/26425)
...
**Problema**: os comerciantes devem ativar a funcionalidade Fastly TLS no Administrador para habilitar o redirecionamento global HTTP para HTTPS para todas as páginas de loja. Consulte o artigo da Base de Dados de Conhecimento [Redirecionar HTTP para HTTPS para todas as páginas na Nuvem (Forçar TLS)](https://support.magento.com/hc/en-us/articles/360006296953). <!-- MC-39988-->
...
**Problema**: os compradores são redirecionados para o carrinho de compras ao tentar fazer um pedido de uma ordem de compra usando o Check-out do PayPal Express quando o **Modo em Contexto** está desabilitado. <!-- B2B-1604-->
...
**Problema**: a consulta `deleteRequisitionListOutput` retorna detalhes sobre a lista de requisições excluídas em vez das listas de requisições restantes. <!-- MC-39894-->
...
Você pode instalar o Adobe Commerce 2.4.2 usando o [Composer](../../../installation/composer.md).
