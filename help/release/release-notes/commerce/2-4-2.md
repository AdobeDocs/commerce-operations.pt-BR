...
A capacidade de configurar uma instalação para usar um banco de dados dividido foi descontinuada nesta versão. Os comerciantes que atualmente usam o banco de dados dividido devem começar a planejar a reversão para um único banco de dados ou a migração para um único banco de dados ou usar uma abordagem alternativa. Consulte [Reverter de um banco de dados dividido para um único banco de dados](../../../configuration/storage/revert-split-database.md) para obter instruções de migração.
...
* Adição de suporte para várias listas de desejos. Você pode usar o GraphQL para [criar](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/create/), [excluir](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/delete/) e [renomear](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/update/) listas de desejos, bem como [mover](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/move-products/) ou [copiar](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/copy-products/) itens entre elas. <!-- MC-32356-->

* Adição de suporte para autorizações de mercadoria retornada (RMA). Os compradores podem [solicitar um retorno](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/mutations/request-return/). Se o comerciante aceitar a solicitação, ele poderá executar tarefas como [adicionar um comentário](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/mutations/add-return-comment/) e [adicionar informações de rastreamento](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/mutations/add-return-tracking/). <!-- MC-34596-->

* Adição de suporte para os seguintes recursos B2B:
   * Empresas. Você pode adicionar [administradores](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create/), [usuários](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create-user/), [funções](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create-role/) e [equipes](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create-team/) da empresa. <!-- MC-33861-->
   * Crédito da empresa. A [consulta de empresa](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/queries/company/) inclui detalhes sobre o histórico de crédito da empresa. <!-- MC-33862-->
   * Listas de requisições. Você pode [criar](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/create/), [excluir](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/delete/) e [atualizar](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/update/) listas de requisições. O suporte também inclui a capacidade de [adicionar](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/add-products/), [atualizar](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/update-products/), [excluir](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/delete-items/), [copiar](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/copy-items/) e [mover](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/move-items/) itens em uma lista de requisições, bem como de adicionar itens de lista de requisições [ao carrinho](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/add-items-to-cart/). <!-- MC-34312-->
...
* [Pagamento do Amazon](https://commercemarketplace.adobe.com//amzn-amazon-pay-magento-2-module.html). O Amazon Pay foi descontinuado nesta versão e será removido no Magento 2.5.0. A versão 2.4.3 e superior conterá apenas atualizações para compatibilidade e correções para bugs principais.
...
* A capacidade de configurar uma instalação para usar um banco de dados dividido foi descontinuada nesta versão.
...
* O título da página Falha do pedido foi revisado para fins de precisão. Anteriormente, esta página era intitulada: **Recebemos seu pedido!**.  [GitHub-29416](https://github.com/magento/magento2/issues/29416)
...
* O aplicativo agora exibe a mensagem Welcome como esperado depois que um comprador faz logon em uma loja onde o carrinho de compras persistente está ativado. Anteriormente, o aplicativo exibia o **Não é você?** mensagem após fazer logon.
...
* As chamadas GET `rest/all/V1/categories` e GET `rest/all/V1/categories?rootCategoryId=2` agora retornam campos `name` e `product_count` preenchidos conforme esperado para todas as categorias na árvore. Anteriormente, os valores do campo de categoria estavam vazios. O plug-in resolvedor de nome de tabela retornou um nome de tabela incorreto para buscar a contagem de produtos por categoria.
