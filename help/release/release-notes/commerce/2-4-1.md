...
* Os clientes agora podem remover pontos de recompensa com êxito na página de revisão do pedido do fluxo de trabalho de check-out ao fazer check-out com vários endereços. Anteriormente, o aplicativo exibia uma `404 Not Found` erro quando um cliente clicou no **Remover** para remover pontos de qualquer endereço. Esse era um problema conhecido na versão 2.4.0.
