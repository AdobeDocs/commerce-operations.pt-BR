...
* **Cobertura GraphQL completa para aspas negociáveis**.  Usuários de empresas B2B agora podem concluir todas as tarefas relacionadas a aspas negociáveis usando GraphQL. As versões anteriores desta API suportavam fluxos de negociação, mas não o check-out. <!-- PWA-2101-->
...
* O GraphQL agora fornece o Novo Relic com nomes descritivos de transação, que podem ser úteis para depuração. [GitHub-30915](https://github.com/magento/magento2/issues/30915)
