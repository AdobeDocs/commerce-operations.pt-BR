...
Habilitar o novo **Atribuição de preço de produto direto do Catálogo Compartilhado habilitado** opção de configuração também melhora o desempenho do indexador de preço do produto. <!-- MCP-946-->
...
* A validação da configuração de ID agora verifica as referências às classes principais não API removidas ou descontinuadas no `di.xml` e preferências para classes e interfaces principais.  <!-- AC-438-->
