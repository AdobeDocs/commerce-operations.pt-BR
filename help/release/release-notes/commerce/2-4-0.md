...
Essa extensão fornecida substitui nossa integração principal do Braintree, que foi removida nesta versão. Consulte [Braintree Payments](https://marketplace.magento.com/paypal-module-braintree.html).
