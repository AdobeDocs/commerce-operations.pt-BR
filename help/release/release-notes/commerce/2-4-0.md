...
* **A renderização de dados para provedores de dados de interface agora está desativada por padrão**. Isso remove a oportunidade de usuários mal-intencionados executarem JavaScript arbitrário. <!-- MC-17356-->
...
* **Melhorias no suporte à Política de segurança de conteúdo (CSP)**. `SecureHtmlRenderer` foi adicionado à Estrutura e está disponível em `.phtml` modelos para inserir na lista de permissões `style` e `script` específicos. Scripts e estilos embutidos não são permitidos com a configuração padrão da CSP, que pode ser substituída por arquivos XML. <!-- MC-34433-->
...
* As ações de salvamento em páginas CMS agora são registradas como esperado em logs de ação de administrador quando **Selecionar todas as ações a serem registradas** está ativado na guia Registro de ações administrativas (**Admin** > **Lojas** > **Configuração** > **Avançado**).

<!-- ENGCOM-7274-->

* As modificações de página do CMS agora são registradas conforme esperado no Log de ações. A MFTF abrange agora este recurso.  _Correção enviada por Lukasz Bajsarowicz na solicitação de pull [27597](https://github.com/magento/magento2/pull/27597)_. [GitHub-171](https://github.com/magento/magento2/issues/171)
...
* Adobe Commerce `cron`Os nomes de tarefas agora são incluídos conforme esperado em Rastreamentos de transação no NewRelic APM Monitoring - Transactions. Isso inclui `cron` tarefas que são executadas a partir da linha de comando, bem como tarefas executadas pelo scheduler padrão.  _Correção enviada por Lukasz Bajsarowicz na solicitação de pull [25957](https://github.com/magento/magento2/pull/25957)_. [GitHub-22047](https://github.com/magento/magento2/issues/22047)

### Informativo

<!-- MC-31768-->

* Os clientes agora podem assinar boletins informativos conforme esperado. Anteriormente, quando um cliente tentava confirmar a assinatura, o aplicativo exibia este erro: `This is an invalid subscription confirmation code`.

<!-- ENGCOM-6525-->

* O campo de entrada do informativo do rodapé da loja agora é renderizado de forma idêntica por qualquer navegador compatível.  _Correção enviada por divyajyothi5321 na solicitação de pull [26182](https://github.com/magento/magento2/pull/26182)_. [GitHub-26176](https://github.com/magento/magento2/issues/26176)

<!-- ENGCOM-6691-->

* As mensagens da loja sobre assinaturas de boletim informativo agora são renderizadas conforme esperado no HTML. _Correção enviada por Oleh Usik na solicitação de pull [26455](https://github.com/magento/magento2/pull/26455)_. [GitHub-25162](https://github.com/magento/magento2/issues/25162)
...
* A implementação principal da proteção contra fraude Signifyd não é mais suportada. Os comerciantes devem migrar para o [Extensão de proteção contra fraudes e chargeback Signifyd](https://marketplace.magento.com/signifyd-module-connect.html) que está disponível no Commerce Marketplace.

<!-- MC-32546-->

* Agora, você pode concluir um pedido com êxito e retornar à página inicial do comerciante quando **Solução Hospedada Pro para Pagamentos de Sites** está configurado. Anteriormente, ao clicar em **Retornar ao comerciante**, o aplicativo emitiu este erro: `Invalid Form Key. Please refresh the page`.

<!-- ENGCOM-6606-->

* Alternar o endereço de faturamento não faz mais com que o texto da função JavaScript seja renderizado na seção de pagamento do fluxo de trabalho de finalização da loja. _Correção enviada por Chris Pook na solicitação de pull [26378](https://github.com/magento/magento2/pull/26378)_. [GitHub-26375](https://github.com/magento/magento2/issues/26375)

<!-- ENGCOM-7223-->

* Os avisos de crédito agora exibem a quantia correta na **Restituição de Ajuste** campo da visão geral Aviso de Crédito.  _Correção enviada por Sergiy Vasiutynskyi na solicitação de pull [27343](https://github.com/magento/magento2/pull/27343)_. [GitHub-13851](https://github.com/magento/magento2/issues/13851)

<!-- ENGCOM-6524-->

* Agora você pode remover informações adicionais do `quote_payment column additional_information` depois de salvar uma cotação. Anteriormente, essas informações não podiam ser removidas depois de salvar a cotação porque `unsAdditionalInformation` método em `\Magento\Payment\Model\Info` O não inicializou os dados corretamente.  _Correção enviada por Marco Oliveira no pull request [26084](https://github.com/magento/magento2/pull/26084)_. [GitHub-26083](https://github.com/magento/magento2/issues/26083)

<!-- ENGCOM-6609-->

* As instruções de pagamento agora são derivadas da visualização da loja da qual um pedido foi feito. Anteriormente, as instruções de pagamento eram usadas na exibição de loja padrão porque `BeforeOrderPaymentSaveObserver` método buscou instruções de pagamento da visualização de loja padrão. _Correção enviada por Karyna Tsymbal em solicitação de pull [26399](https://github.com/magento/magento2/pull/26399)_. [GitHub-26332](https://github.com/magento/magento2/issues/26332)
...
* O aplicativo agora exibe uma mensagem de erro informativa sempre que um cliente clica em **Pagar com PayPal** após inserir um endereço de entrega inválido no workflow de finalização da compra. Anteriormente, o aplicativo exibia uma mensagem de erro somente quando o cliente clicava no botão pela primeira vez, não para cliques subsequentes.

<!-- MC-30639-->

* O aplicativo não altera mais o status de um pedido para `Processing` na seção Análise de Pagamento do fluxo de trabalho de finalização quando um pagamento com PayPal falha.

<!-- MC-30864-->

* Agora é possível concluir um pedido com êxito usando o método de pagamento Link do Fluxo de Pagamento. Anteriormente, o método de pagamento Link do fluxo de pagamento sempre rejeitava o pagamento porque o status do pedido permanecia no `Pending` estado de pagamento, mesmo que o status do pedido nos registros do método de pagamento tenha sido `Approved`.

<!-- MC-32494-->

* Os pedidos feitos usando o PayPal Payflow Pro agora são definidos como `Suspected Fraud` quando os filtros de fraude são acionados.
...
* Os pedidos feitos no PayPal Payflow Pro agora estão definidos como `Suspected Fraud` quando os filtros de fraude são acionados. Anteriormente, o status da transação de pagamento no PayPal não era validado antes da aprovação do pagamento ocorrer no lado do aplicativo.
...
* O método de pagamento PayPal Pro agora funciona conforme esperado no navegador Chrome 80. Esse método de pagamento invocou anteriormente um endpoint de retorno de chamada que precisava de acesso à sessão do cliente — acesso que a nova funcionalidade de cookie SameSite do Chrome padrão não permite. [GitHub-26840](https://github.com/magento/magento2/issues/26840)

<!-- MC-31292-->

* Agora você pode usar o PayPal Express para pagar um pedido quando o carrinho de check-out persistente for ativado e a variável **Limpar Persistência ao Sair** está definida como **não**. Anteriormente, o aplicativo o redirecionava para a página de Logon.

<!-- ENGCOM-6383-->

* Pagamentos do Paypal Express e Web Payments Pro agora migrar para o `Processing` como esperado depois que o processamento tiver começado. Anteriormente, os pagamentos Paypal Web Payments Pro permaneceram no `Pending` estado de pagamento mesmo quando as informações de pagamento estavam no `Processing` estado. _Correção enviada por azambon na solicitação de pull [25876](https://github.com/magento/magento2/pull/25876)_. [GitHub-25659](https://github.com/magento/magento2/issues/25659)
...
* Os comerciantes agora podem usar [carregamento lento](https://en.wikipedia.org/wiki/Lazy_loading) para carregar imagens. _Correção enviada por Timon de Groot na solicitação de pull [27033](https://github.com/magento/magento2/pull/27033)_. [GitHub-27032](https://github.com/magento/magento2/issues/27032)

<!-- ENGCOM-6988-->

* Os gráficos de painel foram migrados para o `chart.js` biblioteca.  _Correção enviada por Bartomiej Szubert na solicitação de pull [26923](https://github.com/magento/magento2/pull/26923). [GitHub-186](https://github.com/magento/community-features/issues/186)_

<!-- ENGCOM-6232-->

* O desempenho das operações executadas em grandes catálogos que contêm muitos atributos de produto (na escala de 3.000 a 2.3000 opções) foi aprimorado pela refatoração de como os arrays de opção de atributo são criados. _Correção enviada por Behnam Shayani na solicitação de pull [25452](https://github.com/magento/magento2/pull/25452)_. [GitHub-20966](https://github.com/magento/magento2/issues/20966)
...
* Agora o alerta de estoque de produtos para cancelar inscrição funciona quando a sessão de um usuário expira. Anteriormente, ao clicar no botão **Clique aqui para interromper os alertas deste produto** link, o aplicativo exibiu um erro 404.

<!-- MC-31979-->

* As ações de cancelamento de inscrição para alertas de produtos agora funcionam conforme esperado. Anteriormente, quando um cliente clicava no **Clique aqui para interromper os alertas deste produto** link, o aplicativo exibiu um erro 404.

### Vídeo do produto

<!-- MC-23743-->

* Agora você pode usar o REST para atualizar vídeos do YouTube (PUT `rest/V1/products/{SKU}`). Anteriormente, o aplicativo exibia uma miniatura do vídeo, mas o reprodutor de vídeo não carregava ao clicar no botão **Reproduzir** botão. [GitHub-23194](https://github.com/magento/magento2/issues/23194)

### Relatórios

<!-- ENGCOM-6635-->

* As listas de produtos agora solicitam produtos configuráveis por SKU, que agrupa produtos configuráveis por variações. Anteriormente, o relatório agrupava os produtos por `product_id`. _Correção enviada por Lukasz Bajsarowicz na solicitação de pull [25858](https://github.com/magento/magento2/pull/25858)_. [GitHub-25856](https://github.com/magento/magento2/issues/25856)

<!-- ENGCOM-6427-->

* A variável **Admin** > **Relatórios** > **Atualizar estatísticas** a tabela agora é exibida **Atualizado em = Nulo** Status como **Nunca** no **Atualizado** coluna em vez de **indefinido**. _Correção enviada por Eden Duong no pull request [25932](https://github.com/magento/magento2/pull/25932)_. [GitHub-25931](https://github.com/magento/magento2/issues/25931)

<!-- ENGCOM-6925-->

* O relatório de Baixo estoque não inclui mais produtos desativados. _Correção apresentada por Mohamed-Asar no pedido de pull [26862](https://github.com/magento/magento2/pull/26862)_. [GitHub-26838](https://github.com/magento/magento2/issues/26838)

<!-- ENGCOM-7110-->

* O aplicativo agora exibe um valor preciso para a variável **Início do Acumulado no Ano**  campo em **Admin**  >  **Lojas**  >  **Configuração**  >  **Geral**  >  **Relatórios**. _Correção enviada por Priya-V-Panchal na solicitação de pull [27088](https://github.com/magento/magento2/pull/27088)_. [GitHub-27086](https://github.com/magento/magento2/issues/27086)

### Autorizações de devolução de produto (RMA)

<!-- MC-24906-->

* O aplicativo não exibe mais um erro quando você cria com êxito um pedido e o RMA na loja. Anteriormente, o aplicativo criava a RMA conforme esperado, mas também exibia este erro:  `We can't create a return right now. Please try again later`.
...
* Uma string desnecessária foi removida do modelo de email do RMA (`app/code/Magento/Rma/view/frontend/email/new.html`).

### Resenhas

<!-- MC-29578-->

* O aplicativo agora desativa a variável **Enviar revisão** depois que o usuário clicar no botão uma vez. Anteriormente, o aplicativo não desativava esse botão após o primeiro clique e criava várias revisões quando o usuário clicava no **Enviar revisão** botão várias vezes.

<!-- MC-31293-->

* A variável **Admin** > **Relatórios** > **Resenhas** > **Por produtos** A lista de filtros agora exibe os resultados conforme esperado. Anteriormente, ao tentar filtrar essa lista, o aplicativo não exibia resultados.

<!-- ENGCOM-6938-->

* O item de menu Revisões pendentes agora é ativado conforme esperado em **Admin** >  **Marketing** > **Conteúdo do usuário** > **Revisões pendentes**.  _Correção enviada pelo Ravinder no pedido de pull [26230](https://github.com/magento/magento2/pull/26230)_. [GitHub-26229](https://github.com/magento/magento2/issues/26229)
...
* O aplicativo agora atende ao endereço de entrega padrão de um cliente. Anteriormente, o aplicativo não respeitava os endereços padrão de faturamento e de envio de acordo com as configurações, e os **Igual ao endereço de cobrança** A configuração do não foi ativada automaticamente.
...
* As caixas de seleção na seção Produtos do **Catálogo** > **Categorias** A página agora funciona conforme esperado.  _Correção enviada por Denis Kopylov na solicitação de pull [22990](https://github.com/magento/magento2/pull/22990)_. [GitHub-22988](https://github.com/magento/magento2/issues/22988)

<!-- ENGCOM-6809-->

* A variável `getCustomer` agora retorna o objeto do cliente conforme definido em `phpdoc` bloco. Anteriormente, esse método retornava `NULL`, e `phpdoc` bloco não realçou que este método poderia retornar `NULL`. _Correção enviada por Fanis Strezos na solicitação de pull [26423](https://github.com/magento/magento2/pull/26423)_. [GitHub-25268](https://github.com/magento/magento2/issues/25268)

<!-- ENGCOM-6492-->

* Os repedidos agora são desativados conforme esperado quando um comerciante desativa o  **Admin** > **Loja**  >  **Configuração**  >  **Vendas**  >  **Reordenar**  >  **Permitir pedido**.  _Correção enviada por Eden Duong no pull request [26051](https://github.com/magento/magento2/pull/26051)_. [GitHub-25130](https://github.com/magento/magento2/issues/25130)

<!-- ENGCOM-6627-->

* `getPrice()` agora o método retorna um flutuante ou nulo em vez de uma string ao definir um preço personalizado para um pedido no Admin.  _Correção enviada por Andrii Chorniy na solicitação de pull [26313](https://github.com/magento/magento2/pull/26313)_. [GitHub-25968](https://github.com/magento/magento2/issues/25968)

<!-- ENGCOM-6786-->

* A variável **Código e título do estado** coluna de **Admin** > **Lojas**  > Configurações >  **Status do pedido** O agora exibe o estado em vez do status conforme esperado.  _Correção enviada por Oleh Usik na solicitação de pull [26569](https://github.com/magento/magento2/pull/26569)_. [GitHub-17847](https://github.com/magento/magento2/issues/17847)

<!-- ENGCOM-6936-->

* As faturas PDF agora capturam a data de compra correta quando criadas em um local GB. _Correção enviada por Eden Duong no pull request [26701](https://github.com/magento/magento2/pull/26701)_. [GitHub-26675](https://github.com/magento/magento2/issues/26675)

### Regra de Vendas

<!-- MC-30155-->

* `quote_item.applied_rule_ids` O agora é atualizado conforme esperado depois que uma regra de preço de carrinho é desativada. [GitHub-24526](https://github.com/magento/magento2/issues/24526)
...
* O aplicativo agora renderiza o **&lt;** e **>** símbolos corretamente nas sequências de pesquisa do catálogo da loja.

<!-- MC-25010-->

* Os produtos agora são exibidos conforme esperado em categorias após a execução `cron:run` em implantações que implementam o Elasticsearch.
...
* O aplicativo não exibe mais um aviso quando um comerciante abre a página de termos de pesquisa clicando na opção Pesquisar termos no rodapé do **Marketing** > **SEO e pesquisa** > **Pesquisar termos**.  _Correção enviada por vishal-webkul na solicitação de pull [25246](https://github.com/magento/magento2/pull/25246)_. [GitHub-25245](https://github.com/magento/magento2/issues/25245)

<!-- ENGCOM-7289-->

* O aplicativo não redimensiona mais o visor ao clicar na caixa de entrada de pesquisa ao executar o Safari na visualização móvel.  _Correção enviada por Pawe Tylek na solicitação de pull [27603](https://github.com/magento/magento2/pull/27603). [GitHub-27506](https://github.com/magento/magento2/issues/27506)_
...
* O aplicativo agora imprime etiquetas de remessa como um `.pdf` arquivo como esperado ao selecionar **Imprimir etiqueta de remessa** na lista suspensa Ação de um pedido na lista order archive. Anteriormente, o aplicativo exibia um erro 404.
...
* O aplicativo não exibe mais uma página em branco em vez de exibir todas as transportadoras na caixa suspensa/de seleção múltipla. Anteriormente, um erro no `toOptionArray` função em `vendor/magento/module-shipping/Model/Config/Source/Allmethods.php` ocorreu. _Correção enviada por Marc Rodriguez no pedido de pull [25315](https://github.com/magento/magento2/pull/25315)_. [GitHub-13136](https://github.com/magento/magento2/issues/13136)
...
* Os mapas de site gerados agora incluem o URL da página inicial. _Correção enviada pela deepaksnair na solicitação de pull [26445](https://github.com/magento/magento2/pull/26445)_. [GitHub-25761](https://github.com/magento/magento2/issues/25761)
...
* Agora, os comerciantes podem adicionar atributos de amostra de cor com sucesso aos produtos usando o **Amostra visual** opção ativada **Lojas** > **Atributos** > **Produto** > **Novo atributo**. Anteriormente, um erro de JavaScript era disparado quando você tentava abrir o atributo de amostra recém-criado.
...
* O aplicativo não emite mais um erro quando você edita e salva o `NOT LOGGED IN` grupo de clientes quando B2B estiver instalado.

### Teste

>[!NOTE]
>
>**O MFTF agora usa o Google Authenticator para executar testes com o 2FA ativado. O MFTF não funcionará com 2.4.0 sem etapas de configuração adicionais para habilitar o Google Authenticator**. Consulte [Configuração do MFTF para autenticação de dois fatores (2FA)](https://devdocs.magento.com/guides/v2.4/security/two-factor-authentication.html#magento-functional-testing-framework).
...
* Os testes agora abrangem a tarefa de registrar Ações do administrador relacionadas às páginas do CMS. _Correção enviada por Lukasz Bajsarowicz na solicitação de pull 172 no repositório privado partners-magento2ee_. [GitHub-171](https://github.com/magento/magento2/issues/171)

<!-- ENGCOM-7040 7051-->

* Nomes de testes funcionais inválidos foram revisados para seguir as práticas recomendadas. _Correção enviada por Lukasz Bajsarowicz na solicitação de pull [27118](https://github.com/magento/magento2/pull/27118) e pull request 151 no repositório privado partners-magento2ee. [GitHub-27117](https://github.com/magento/magento2/issues/27117)_

<!-- ENGCOM-7026-->

* Adobe Commerce `cron` agora é usado para reindexação após a criação de dados de teste e, quando aplicável, `cache:flush config` substitui `cache:flush`. _Correção enviada por Lukasz Bajsarowicz na solicitação de pull [26990](https://github.com/magento/magento2/pull/26990)_. [GitHub-26989](https://github.com/magento/magento2/issues/26989)

<!-- ENGCOM-7421-->

* Os testes de aceitação agora seguem as convenções de nomenclatura para `Magento/Indexer` e `Magento/Backup` módulos.  _Correção enviada por Shankar Konar em solicitação de pull [27515](https://github.com/magento/magento2/pull/27515)_. [GitHub-27503](https://github.com/magento/magento2/issues/27503)

<!-- ENGCOM-6791 6825-->

* A variável `AdminReorderWithCatalogPrice` O teste foi refatorado e não falha mais durante o processo de validação de CI. _Correção enviada por Lukasz Bajsarowicz na solicitação de pull 135 no repositório privado partners-magento2ee_. [GitHub-26607](https://github.com/magento/magento2/issues/26607)

<!-- ENGCOM-6780 6795-->

* A variável `AdminAddingNewOptionsWithImagesAndPricesToConfigurableProduct` e `StorefrontApplyPromoCodeDuringCheckout` os testes foram refatorados e não falham mais durante o processo de validação de CI. _Correção enviada por Lukasz Bajsarowicz na solicitação de pull [26611](https://github.com/magento/magento2/pull/26611) e pull request [26614](https://github.com/magento/magento2/pull/26614)_. [GitHub-26612](https://github.com/magento/magento2/issues/26612), [GitHub-26610](https://github.com/magento/magento2/issues/26610)

<!-- ENGCOM-6621-->

* A variável `DeleteProduct and DeleteCustomer Action Groups` os testes foram refatorados e não falham mais durante o processo de validação de CI. _Correção enviada por Lukasz Bajsarowicz na solicitação de pull [26407](https://github.com/magento/magento2/pull/26407)_. [GitHub-26396](https://github.com/magento/magento2/issues/26396)

<!-- ENGCOM-6608-->

* A variável `AdminMoveAnchoredCategoryTest.xml` os testes foram refatorados e não falham mais durante o processo de validação de CI. _Correção enviada por Lukasz Bajsarowicz na solicitação de pull [26395](https://github.com/magento/magento2/pull/26395)_. [GitHub-26396](https://github.com/magento/magento2/issues/26396)

#### Testes de integração

<!-- ENGCOM-7143-->

* Solicitações consecutivas em testes de integração não falham mais. Anteriormente, os testes falhavam porque os objetos de solicitação eram compartilhados entre os despachos. A variável `resetRequest` agora esvazia o estado de `request`. _Correção enviada por Lukasz Bajsarowicz na solicitação de pull [27300](https://github.com/magento/magento2/pull/27300)_. [GitHub-27299](https://github.com/magento/magento2/issues/27299)

<!-- ENGCOM-7262-->

* Testes de integração adicionais adicionados para abranger o `Magento_Customer` recursos de email. _Correção enviada por Lukasz Bajsarowicz na solicitação de pull [27606](https://github.com/magento/magento2/pull/27606)_. [GitHub-27607](https://github.com/magento/magento2/issues/27607)

#### Testes de unidade do PHP

<!-- ENGCOM-7435 7306-->

* Os testes de unidade do PHP não lançam mais este erro fatal: `Fatal error: Class Mock_CartExtensionInterface_0ba80a0b contains 2 abstract methods and must therefore be declared abstract or implement the remaining methods (Magento\Quote\Api\Data\CartExtensionInterface::getAmazonOrderReferenceId, Magento\Quote\Api\Data\CartExtensionInterface::setAmazonOrderReferenceId) in /var/www/html/vendor/phpunit/phpunit-mock-objects/src/Generator.php(264) : eval()'d code on line 1`. _Correção enviada por Lukasz Bajsarowicz em solicitações de pull 178 no repositório privado partners-magento2ee e [27701](https://github.com/magento/magento2/pull/27701)_. [GitHub-27638](https://github.com/magento/magento2/issues/27638)

<!-- ENGCOM-7271-->

* Testes para `Offline_Payments` agora são compatíveis com o PHPUnit 8.  _Correção enviada por Cristiano Pacheco na solicitação de pull [27627](https://github.com/magento/magento2/pull/27627)_. [GitHub-27500](https://github.com/magento/magento2/issues/27500)

<!-- ENGCOM-7243 7284 7291-->

* Testes de unidade para `Framework`, `AdminAnalytics`, `AdminNotification`, e `AMPQ` foram atualizadas para o PHPUnit 8. _Correção enviada por Ihor Sviziev em solicitações de pull [27522](https://github.com/magento/magento2/pull/27522), [27521](https://github.com/magento/magento2/pull/27521), [27519](https://github.com/magento/magento2/pull/27519), [27522](https://github.com/magento/magento2/pull/27522)_. [GitHub-27500](https://github.com/magento/magento2/issues/27500)

<!-- ENGCOM-6542-->

* Agora você pode executar o `\Magento\Downloadable\Test\Unit\Helper\DownloadTest` teste de unidade sem estar conectado à internet.  _Correção enviada por aleromano89 na solicitação de pull [26264](https://github.com/magento/magento2/pull/26264)_. [GitHub-23521](https://github.com/magento/magento2/issues/23521)

<!-- ENGCOM-6695-->

* Adição do teste de unidade para `app/code/Magento/Fedex/Model/Source/Generic.php`. _Correção enviada por Sathish Subramanian na solicitação de pull [26549](https://github.com/magento/magento2/pull/26549)_.

<!-- ENGCOM-7251 7283 7472-->

* `<magentoCron>` foi adicionado a vários testes, o que aciona uma reindexação parcial. Essas alterações abordam problemas que criavam falsos negativos nos testes funcionais abrangidos `Magento_Bundle`, `CatalogImportExport`, `CatalogInventory`, `CatalogRule`, `Backend`, `Braintree`, e `Captcha`. _Correção enviada por Lukasz Bajsarowicz em solicitações de pull [27322](https://github.com/magento/magento2/pull/27322), [27323](https://github.com/magento/magento2/pull/27323), [27321](https://github.com/magento/magento2/pull/27321)_. [GitHub-27320](https://github.com/magento/magento2/issues/27320)

<!-- ENGCOM-6844-->

* Todos os usos incorretos de `<amOnPage>` foram substituídas por um `<actionGroup>` para logout de administrador, quando aplicável, em testes. _Correção enviada por Lukasz Bajsarowicz na solicitação de pull 116 no repositório privado partners-magento2ee_. [GitHub-26331](https://github.com/magento/magento2/issues/26331)
...
* Cada grupo de ação em um teste foi movido para um arquivo separado para seguir as práticas recomendadas do MFTF e nomes de arquivo inconsistentes foram revisados. Os testes dos seguintes módulos foram afetados:
  ...
  _Correção enviada por Lukasz Bajsarowicz em solicitações de pull [25800](https://github.com/magento/magento2/pull/25800), [26323](https://github.com/magento/magento2/pull/26323), [26321](https://github.com/magento/magento2/pull/26321), [26320](https://github.com/magento/magento2/pull/26320), [26319](https://github.com/magento/magento2/pull/26319), [26322](https://github.com/magento/magento2/pull/26322), [25828](https://github.com/magento/magento2/pull/25828), [26329](https://github.com/magento/magento2/pull/26329) (e pull requests 104, 105, 106, 107, 108, 109, 111, 119, 120, 121 em private repository partners-magento2ee)_. [GitHub-22853](https://github.com/magento/magento2/issues/22853)

### Tema

<!-- MC-29804-->

* Resolvemos um erro em `JsFooterPlugin.php` que afetou a exibição de blocos dinâmicos. Anteriormente, o aplicativo exibia esse erro quando você acessava diretamente `/banner/ajax/load/url`: `Uncaught TypeError: strpos() expects parameter 1 to be string, null given in`.

<!-- ENGCOM-6708-->

* A variável `i18n` O método fornece a capacidade de adicionar uma string para sublinhar os modelos.  _Correção enviada por Sergiy Vasiutynskyi na solicitação de pull [26435](https://github.com/magento/magento2/pull/26435)_. [GitHub-18012](https://github.com/magento/magento2/issues/18012)

<!-- ENGCOM-6666-->

* A variável `section-config` O módulo foi refatorado. Essa refatoração reduziu os erros causados por módulos de terceiros que fazem solicitações de POST ou solicitam dados do cliente diretamente antes que o módulo fosse inicializado pelo `data-mage-init`. _Correção enviada por Mateusz Krzeszowiak em um pedido de pull [25764](https://github.com/magento/magento2/pull/25764)_. [GitHub-17125](https://github.com/magento/magento2/issues/17125)

<!-- ENGCOM-6924-->

* `LoadCssAsync` Foram corrigidos erros no formato HTML. _Correção enviada por Sathish Subramanian na solicitação de pull [26764](https://github.com/magento/magento2/pull/26764)_. [GitHub-26760](https://github.com/magento/magento2/issues/26760)

<!-- ENGCOM-7052-->

* Ao criar `default.xml` e `catalog_product_view.xml` arquivos como parte da criação de um novo tema, o aplicativo cria essas páginas ou registra erros nos arquivos de log, conforme esperado. Anteriormente, o aplicativo registrava erros em `vendor/magento/framework/View/Page/Config/Renderer.php` arquivo. _Correção enviada por Vinh Le no pedido de pull [27026](https://github.com/magento/magento2/pull/27026)_. [GitHub-27009](https://github.com/magento/magento2/issues/27009)

### Tradução e códigos de idiomas

<!-- MC-24186-->

* A tradução em linha agora funciona conforme esperado na loja quando **Admin** > **Lojas** > **Configuração** > **Avançado** > **Desenvolvedor** > **Traduzir em linha** > **Ativado para vitrine** está definido.
...
* As chaves de URL do produto agora são transliteradas conforme esperado. _Correção enviada por DanieliMi no pedido de pull [26506](https://github.com/magento/magento2/pull/26506)_. [GitHub-26499](https://github.com/magento/magento2/issues/26499)

<!-- ENGCOM-6899-->

* A variável `es_US Spanish (United States)` A localidade agora é compatível. _Correção enviada por Vinh Le no pedido de pull [26857](https://github.com/magento/magento2/pull/26857)_. [GitHub-26843](https://github.com/magento/magento2/issues/26843)

<!-- ENGCOM-6996-->

* A contagem de espaço reservado numérico e a contagem de espaço reservado de código JavaScript agora são a mesma. Anteriormente, o código JavaScript assumia 0%, enquanto a contagem numérica de espaços reservados começava com %1.  _Correção enviada pelo korostii na solicitação de pull [25359](https://github.com/magento/magento2/pull/25359)_. [GitHub-25243](https://github.com/magento/magento2/issues/25243)

<!-- ENGCOM-6557-->

* Agora é possível desativar a tradução do título da página da página Detalhes do produto (`page.main.title`), que é ativado por padrão. _Correção enviada por Bartomiej Szubert na solicitação de pull [26269](https://github.com/magento/magento2/pull/26269)_. [GitHub-7065](https://github.com/magento/magento2/issues/7065)

<!-- ENGCOM-7465-->

* Problemas com a renderização de árabe e hebraico em PDF de fatura foram resolvidos. _Correção enviada por Ihor Sviziev em uma solicitação de pull [27887](https://github.com/magento/magento2/pull/27887)_. [GitHub-25769](https://github.com/magento/magento2/issues/25769)
...
* O aplicativo agora exibe esta mensagem de erro quando você insere um caractere não-latino para um nome de pasta em códigos de idiomas onde somente letras latinas são suportadas: `Please rename the folder using only Latin letters, numbers, underscores and dashes`. _Correção enviada por Eden Duong no pull request [25904](https://github.com/magento/magento2/pull/25904). [GitHub-25896](https://github.com/magento/magento2/issues/25896)_

<!-- ENGCOM-6539-->

* O comprimento do `locale` coluna para `directory_country_region_name` foi aumentado de 8 para 16 para oferecer suporte a localidades como  `zh_Hans_CN`. _Correção enviada por Bartomiej Szubert na solicitação de pull [26268](https://github.com/magento/magento2/pull/26268)_. [GitHub-14001](https://github.com/magento/magento2/issues/14001)

### IU

<!-- MC-32547-->

* Agora você pode usar o Page Builder para adicionar um produto como um link de botão (**Editar conteúdo** > **Link do botão**). Anteriormente, o aplicativo exibia este erro quando você tentava selecionar o produto: `Product with ID: XXXX doesn't exist`.

<!-- ENGCOM-7490-->

* O botão Voltar agora funciona conforme esperado do **Admin** > **Lojas** > **Status do pedido** > **Editar status do pedido**. _Correção enviada por Vadim Malesh em solicitação de pull [27976](https://github.com/magento/magento2/pull/27976)_. [GitHub-1270](https://github.com/magento/magento2/issues/1270)

<!-- ENGCOM-6692-->

* A visualização de imagens não é mais alterada inesperadamente quando você usa as teclas de seta para mover o cursor no **Nome do arquivo** na lista do Adobe Stock. _Correção enviada por Adarsh Manickam na solicitação de pull [25991](https://github.com/magento/magento2/pull/25991)_. [GitHub-847](https://github.com/magento/magento2/issues/847)

<!-- ENGCOM-6414-->

* A variável **Sua senha**  na seção Verificação de identidade do usuário atual do **Admin** > **Sistema** > **Integrações** A página agora herda estilos conforme esperado. _Correção enviada por Eduard Chitoraga na solicitação de pull [25918](https://github.com/magento/magento2/pull/25918)_. [GitHub-25917](https://github.com/magento/magento2/issues/25917)

<!-- ENGCOM-6482-->

* A entrada validada pelo validador do JavaScript na loja também passará na validação pelo Admin. Anteriormente, o validador JavaScript contava as novas linhas como um único caractere na vitrine, mas no lado do servidor, `\Magento\Catalog\Model\Product\Option\Type\maxCharacters` novas linhas contadas como dois caracteres. _Correção enviada por Grzegorz Bogusz no pedido de pull [26033](https://github.com/magento/magento2/pull/26033)_. [GitHub-25974](https://github.com/magento/magento2/issues/25974)

<!-- ENGCOM-6517-->

* A variável `subTitle` não é mais apagada quando você altera um título modal usando o `setTitle()` chame. Anteriormente, ao tentar criar um pop-up ou modal personalizado com um título e subtítulo, você alterava o título com o `setTitle()` , o `subTitle` foi apagado. _Correção enviada por Andrea Parmeggiani em solicitação de pull [26142](https://github.com/magento/magento2/pull/26142)_. [GitHub-26141](https://github.com/magento/magento2/issues/26141)
...
* A tabela `quote`  coluna `customer_note` agora usa o tipo `text` conforme esperado. Anteriormente, ele usava o tipo `varchar(255)`. _Correção enviada por Ravi Chandra no pedido de pull [26160](https://github.com/magento/magento2/pull/26160)_. [GitHub-26155](https://github.com/magento/magento2/issues/26155)

<!-- ENGCOM-7153-->

* Problemas de exibição corrigidos com o cabeçalho da tabela no **Minha conta**  > **Catálogo de Endereços**  Tabela de Entradas de Endereço.  _Correção enviada por Abrar Pathan na solicitação de pull [27336](https://github.com/magento/magento2/pull/27336)_. [GitHub-27335](https://github.com/magento/magento2/issues/27335)

<!-- ENGCOM-5986-->

* O símbolo de moeda usado na Etapa de preço da navegação em camadas agora se baseia nas configurações padrão, conforme esperado.  _Correção enviada por Bartomiej Szubert na solicitação de pull [24815](https://github.com/magento/magento2/pull/24815)_. [GitHub-21684](https://github.com/magento/magento2/issues/21684)

<!-- ENGCOM-6324-->

* O símbolo da moeda bielorrussa (BYR) foi atualizado para BYN. _Correção enviada por Bartomiej Szubert na solicitação de pull [25723](https://github.com/magento/magento2/pull/25723)_. [GitHub-24713](https://github.com/magento/magento2/issues/24713)

<!-- ENGCOM-6622-->

* A seção Comparar produtos da página Catálogo agora é exibida, conforme esperado, na exibição móvel em exibições com resoluções inferiores a 767px. _Correção enviada pela Hitesh na solicitação de pull [26418](https://github.com/magento/magento2/pull/26418)_. [GitHub-26416](https://github.com/magento/magento2/issues/26416)

<!-- ENGCOM-6376-->

* A rolagem de páginas de produtos agora funciona conforme esperado na exibição móvel.  _Correção enviada por Mateusz Krzeszowiak em um pedido de pull [25385](https://github.com/magento/magento2/pull/25385)_. [GitHub-10518](https://github.com/magento/magento2/issues/10518), [GitHub-21717](https://github.com/magento/magento2/issues/21717)

<!-- ENGCOM-6368-->

* Agora você pode rolar pelas imagens em miniatura da galeria na página do produto na exibição móvel, conforme esperado. _Correção enviada por Gerchak na solicitação de pull [25839](https://github.com/magento/magento2/pull/25839)_. [GitHub-21014](https://github.com/magento/magento2/issues/21014)

<!-- ENGCOM-6425-->

* Clicar no Título do Tema em **Admin**  > **Conteúdo** > **Temas** não resulta mais em registros duplicados. _Correção enviada por Eden Duong no pull request [25926](https://github.com/magento/magento2/pull/25926)_. [GitHub-25925](https://github.com/magento/magento2/issues/25925)
...
* O link Adicionar para comparar na página de detalhes do produto agora é renderizado corretamente na exibição móvel em exibições com resolução inferior a 640px. _Correção enviada por Pawe Tylek na solicitação de pull [26424](https://github.com/magento/magento2/pull/26424) e Tejash Kumbhare na solicitação de pull [26365](https://github.com/magento/magento2/pull/26365)_. [GitHub-26364](https://github.com/magento/magento2/issues/26364)

<!-- ENGCOM-6607-->

* A variável **Classificar por** o rótulo não se sobrepõe mais ao **Comprar por** na página categoria da exibição móvel. _Correção enviada por Andrii Kartavtsev na solicitação de pull [26381](https://github.com/magento/magento2/pull/26381)_. [GitHub-25300](https://github.com/magento/magento2/issues/25300)

<!-- ENGCOM-7137-->

* Agora é possível atualizar o valor da amostra de um produto baixável e o título do link, habilitando o  **Usar padrão** caixa de seleção _Correção enviada por Abel Truong na solicitação de pull [27295](https://github.com/magento/magento2/pull/27295)_. [GitHub-27169](https://github.com/magento/magento2/issues/27169)

<!-- ENGCOM-6532-->

* Espaçamento corrigido entre as variáveis **Atualizar** botão e **Qtd** no minicarrinho.  _Correção enviada pela Hitesh na solicitação de pull [26234](https://github.com/magento/magento2/pull/26234)_. [GitHub-26227](https://github.com/magento/magento2/issues/26227)

<!-- ENGCOM-7032-->

* A cor da borda inferior da tabela Entradas Adicionais de Endereço na página Catálogo de Endereços agora corresponde `thead` e `tbody` cor da borda. _Correção enviada por Tejash Kumbhare na solicitação de pull [26649](https://github.com/magento/magento2/pull/26649)_. [GitHub-26648](https://github.com/magento/magento2/issues/26648)

<!-- ENGCOM-7195-->

* Os modais de prompt não executam mais uma ação de confirmação quando um usuário clica na sobreposição modal. _Correção enviada por Serhiy Zhovnir em solicitação de pull [27399](https://github.com/magento/magento2/pull/27399)_.
...
* A validação da lógica de chave de URL da categoria foi aprimorada. _Correção enviada por Sergiy Vasiutynskyi na solicitação de pull [27412](https://github.com/magento/magento2/pull/27412)_. [GitHub-13689](https://github.com/magento/magento2/issues/13689)
...
* As operações de reescrita de URL não removem mais uma string de consulta de um URL quando o URL tem uma barra à direita.  _Correção enviada por Alexey Arendarenko no pedido de pull [25603](https://github.com/magento/magento2/pull/25603)_. [GitHub-18717](https://github.com/magento/magento2/issues/18717)

### IVA

<!-- ENGCOM-7458-->

* Corrigido o URL de Validação de IVA para [Números de IVA da UE](https://ec.europa.eu/taxation_customs/vies/checkVatService.wsdl).  _Correção enviada por Shikha Mishra na solicitação de pull [27886](https://github.com/magento/magento2/pull/27886)_. [GitHub-27874](https://github.com/magento/magento2/issues/27874)
...
* Problemas corrigidos com o POST `/rest/default/async/bulk/V1/orders` chamadas.

<!-- MC-30675-->

* Problemas corrigidos com o POST `/rest/default/async/bulk/V1/products` chamadas.

<!-- ENGCOM-6945-->

* A variável `getList` foi refatorado para recuperar o `is_subscribed` atributo de extensão. Anteriormente, não era possível recuperar esse atributo ao buscar uma entidade do cliente por meio da API. _Correção enviada pelo enriquecido4 no pull request [25311](https://github.com/magento/magento2/pull/25311)_. [GitHub-13252](https://github.com/magento/magento2/issues/13252)

<!-- ENGCOM-6500-->

* Atualizando informações do cliente por meio do `/V1/customers/:id` não redefine mais o `group_id` desnecessariamente. Anteriormente, ao atualizar um cliente por meio do REST, o grupo de clientes era alterado para 1 se o corpo não contivesse um grupo de clientes. _Correção enviada por MaxRomanov4669 na solicitação de pull [25958](https://github.com/magento/magento2/pull/25958)_. [GitHub-14663](https://github.com/magento/magento2/issues/14663)

<!-- ENGCOM-6920-->

* Os getters anuláveis em contratos de serviço não lançam erros de reflexão quando usados na API da Web. Métodos que podem retornar nulo e um tipo válido agora funcionam corretamente independentemente da ordem também.  _Correção enviada por Marco K̦solicitação de pull pcke in [25806](https://github.com/magento/magento2/pull/25806)_. [GitHub-25656](https://github.com/magento/magento2/issues/25656)
...
* A paginação dos resultados de solicitações REST agora é precisa. Anteriormente, ao solicitar resultados de uma página específica (por exemplo, `page_size` = 1 e a `current_page` que estava fora do escopo), a chamada retornada repetiu a última página de resultados em vez de uma mensagem informativa.  _Correção enviada por Lukasz Bajsarowicz na solicitação de pull [26988](https://github.com/magento/magento2/pull/26988)_. [GitHub-26986](https://github.com/magento/magento2/issues/26986), [GitHub-8099](https://github.com/magento/magento2/issues/8099)

<!-- ENGCOM-6540-->

* O resultado do GET `/V1/orders/items/{id}` agora inclui um elemento de atributo de extensão que inclui dados de mensagem de presente. _Correção enviada por Laura Folco no pedido de pull [25946](https://github.com/magento/magento2/pull/25946)_. [GitHub-19093](https://github.com/magento/magento2/issues/19093)
...
* O aplicativo agora exibe a página Minha lista de desejos como esperado em exibições com resolução superior a 768px e inferior a 1023px. _Correção enviada pela Hitesh na solicitação de pull [26546](https://github.com/magento/magento2/pull/26546)_. [GitHub-26543](https://github.com/magento/magento2/issues/26543)

<!-- ENGCOM-7062-->

* O email gerado ao clicar em **Compartilhar lista de desejos** O agora exibe as mesmas imagens de produto que a página Lista de desejos. _Correção enviada por Michael Bottens na solicitação de pull [27125](https://github.com/magento/magento2/pull/27125). [GitHub-27124](https://github.com/magento/magento2/issues/27124)_
...
* O carregador de imagem WYSIWYG agora usa `pub/media/wysiwyg` como a raiz de armazenamento. Anteriormente, o carregado utilizado `pub/media` como sua raiz de armazenamento, que tornava as imagens carregadas inacessíveis após alterações recentes no código do carregador de imagem. _Correção enviada por Pieter Hoste na solicitação de pull [24878](https://github.com/magento/magento2/pull/24878)_. [GitHub-22609](https://github.com/magento/magento2/issues/22609)

<!-- ENGCOM-7045-->

* O TinyMCE4 no navegador Chrome agora lida com caracteres de byte duplo conforme esperado. Anteriormente, o TinyMCE4 não podia manipular corretamente caracteres de byte duplo (como os usados em chinês) no Chrome. _Correção enviada por Hirokazu Nishi no pedido de pull [25454](https://github.com/magento/magento2/pull/25454)_. [GitHub-24637](https://github.com/magento/magento2/issues/24637)

## Problemas conhecidos — geral

**Problema**: Anomalias nas mensagens de erro da loja ocorrem em implantações onde o PHP 7.4.2 está instalado. Quando 2.4.0 é implantado com o PHP 7.4.2, os símbolos de espaço nas mensagens de erro da loja são substituídos por caracteres de adição (+). Este bug é nativo do PHP 7.4.2 e não pode ser corrigido pelo Adobe Commerce. **Solução alternativa**: Nós recomendamos usar outras versões do PHP 7.4.x. Consulte [Exibição de dados de mensagens brutas na loja](https://support.magento.com/hc/en-us/articles/360045804332)  Artigo da knowledge base. <!-- MC-34170-->

**Problema**: os comerciantes não podem adicionar produtos solicitados a um pacote da página Admin Create Package e salvar o pacote. Consulte [Criação de etiquetas de remessa](https://support.magento.com/hc/en-us/articles/360046750171) Artigo da knowledge base. A variável **MC-35514-2.4.0-CE-composer.patch** A correção para esse problema agora está disponível em [Versões](https://magento.com/tech-resources/download). <!-- MC-35514-->

**Problema**: o aplicativo exibe essa mensagem de erro durante a instalação com extensões de terceiros que dependem de APIs para o `Store` módulo em comandos CLI: `The default website isn't defined. Set the website and try again`. **Solução alternativa**: remova as dependências de extensões de terceiros do Composer, instale o Magento e instale extensões de terceiros.

**Problema**: A variável **Adicionar seleções ao meu carrinho** botão na parte inferior do carrinho de compras não funciona. **Solução alternativa**: Use o **Adicionar seleções ao meu carrinho** na parte superior da página. Consulte [Adicionar seleções ao meu botão de carrinho não funciona](https://support.magento.com/hc/en-us/articles/360045838312) Artigo da knowledge base. <!-- MC-35313-->

**Problema**: os comerciantes não podem interagir com nenhum elemento de página na página Devoluções após criar uma etiqueta de remessa para uma Autorização de devolução de produto (RMA). Consulte [Retorna Editar página para de funcionar ao criar rótulo de remessa](https://support.magento.com/hc/en-us/articles/360046441312) Artigo da knowledge base. A variável **MC-35984-2.4.0-composer.patch** A correção para esse problema agora está disponível em [Versões](https://magento.com/tech-resources/download). <!-- MC-35984-->

**Problema**: os administradores não podem adicionar um produto configurável por SKU a uma cotação. Quando um administrador clica no ícone **Adicionar à Cotação** , a página Edição de Cotações permaneceu em um estado de carregamento e o administrador não pôde salvar suas alterações. **Solução alternativa**: não há solução alternativa para edição da Cotação B2B.  No entanto, você ainda pode solicitar produtos selecionando os produtos na lista de produtos em vez de adicioná-los por SKU. Consulte [O administrador B2B não pode adicionar um produto configurável a uma cotação](https://support.magento.com/hc/en-us/articles/360046801971) Artigo da knowledge base. <!-- MC-35513-->

**Problema**: os comerciantes não podem criar um novo pedido com o Administrador porque o **Adicionar produtos por SKU** e **Adicionar produtos**  Os botões estão ausentes na página de criação de pedido quando o empacotamento do JavaScript é ativado.  **Solução alternativa**: Desative o agrupamento JavaScript para sua implantação. <!-- MC-36044-->

**Problema**: A aplicação a `404 not found` erro quando um cliente tenta remover pontos de premiação ao verificar um pedido enviado para vários endereços. <!-- MC-35955-->

**Problema**: editar um produto configurável na lista de desejos de um cliente resulta no seguinte comportamento inesperado: um campo inesperado é exibido na página Configurar produto e a página Configurar produto não desaparece após clicar em **OK**. O aplicativo também exibe esta mensagem: `Please load Wish List item`. **Solução alternativa**: recarregue a página Configurar produto. <!-- MC-35617-->

**Problema**: os clientes não podem alterar o número de pedidos exibidos por página quando a lista Pedidos abrange várias páginas. No momento, o aplicativo exibe essa mensagem quando você navega até a última página de pedidos e tenta alterar o número de pedidos exibidos por página: `You have placed no orders`. Consulte [Erro de exibição de pedidos](https://support.magento.com/hc/en-us/articles/360046802271) Artigo da knowledge base.  **Solução alternativa**: reabrir a página Meus pedidos resultará na exibição da lista Pedidos. <!-- MC-34153-->

**Problema**: Clicando diretamente no link **Exportar Alíquotas de Imposto** botão da página Adicionar Nova Regra de Imposto ( **Lojas** > **Regras de Imposto**) não baixa o `tax_rates.csv` conforme esperado. **Solução alternativa**: Clique na borda da variável  **Exportar Alíquotas de Imposto** botão.  Consulte [Exportar Alíquotas de Imposto não funciona](https://support.magento.com/hc/en-us/articles/360045850032)  Artigo da knowledge base. <!-- MC-35345-->

**Problema**: A variável **Atualizar** os botões dos Últimos itens solicitados, Produtos na Lista de comparação e Produtos comparados recentemente na página Atividades do cliente do administrador não funcionam como esperado. No momento, o aplicativo rola a página sempre que o **Atualizar** for clicado e não exibir o nome do produto. Consulte [A atualização das Atividades do cliente não funciona](https://magento.zendesk.com/hc/en-us/articles/360046091332) Artigo da knowledge base. <!-- MC-35296-->

### B2B

**Problema**: Se um código de desconto expirar antes da aprovação de uma Ordem de Compra (OC), a OC continuará a exibir a quantia descontada, mas uma vez aprovada a OC, ela será colocada no total não descontado. **Solução alternativa**: Instale o **B2B-709 Correção de desconto de ordem de compra** correção para esse problema, que agora está disponível no **Minha conta** > **Downloads** seção de `magento.com`.

**Problema**: o aplicativo apresenta uma exceção durante a atualização para B2B 1.2.0 em uma implantação de vários sites. Quando `setup:upgrade` for executado, esse erro ocorrerá no `PurchaseOrder` módulo: `Module Magento_PurchaseOrder: Unable to apply data patch Magento\PurchaseOrder\Setup\Patch\Data\InitPurchaseOrderSalesSequence for moduleMagento_PurchaseOrder`. **Solução alternativa**: Instale o **B2B-716 Adicionar interface NonTransactionableInterface ao patch de dados InitPurchaseOrderSalesSequence** que agora está disponível no **Minha conta** > **Downloads** seção de `magento.com`.

## Problemas conhecidos — VBE

### Amazon Pay

* **Problema**: os métodos de pagamento estão ausentes no fluxo de trabalho de check-out quando um cliente clica em **Retornar ao check-out padrão** durante o checkout com o Amazon Pay.  **Solução alternativa**: atualize a página de check-out para exibir os métodos ausentes.  <!-- BUNDLE-2661-->
...
* **Problema**: o aplicativo apresenta um erro ao abrir o **Vendas** > **Terminal virtual Braintree**. Embora o formulário contenha elementos corrompidos da interface do usuário, ele ainda aceita pagamentos. **Solução alternativa**: salve as credenciais de Braintree corretas, que corrigirão os campos de entrada recolhidos. Consulte [A página do Terminal Virtual do Braintree está corrompida](https://support.magento.com/hc/en-us/articles/360046800071)  Artigo da knowledge base. A variável **BUNDLE-2670_VirtualTerminal.patch** A correção para esse problema agora está disponível em [Versões](https://magento.com/tech-resources/download). <!-- BUNDLE-2670-->

* **Problema**: O aplicativo exibe uma mensagem de erro nos seguintes países quando um cliente seleciona um método de pagamento local durante a finalização da compra: Bélgica, Holanda, Itália, Espanha e Polônia.  **Solução alternativa**: Ignore a mensagem de erro e continue com o pagamento.

### dotdigital

* **Problema**: os testes de integração falham com este erro: `PHP Fatal error: Declaration of Dotdigitalgroup\Email\Test\Integration\Model\Sync\Importer\ImporterFailedTest::setUp() must be compatible with PHPUnit\Framework\TestCase::setUp(): void in /var/www/vendor/dotmailer/dotmailer-magento2-extension/Test/Integration/Model/Sync/Importer/ImporterFailedTest.php on line 36`. **Solução alternativa**: A variável **Pacote-2684 Patch de testes da integração digital Dotdigital** A correção para esse problema agora está disponível em [Versões](https://magento.com/tech-resources/download). <!-- BUNDLE-2684-->

### Klarna

* **Problema**: Saindo do **Tema de design** campo em branco em Mensagens no local do Klarna (**Admin**  >  **Lojas**  >  **Configuração**  > **Configurações do Klarna**) resulta em uma página em branco.  **Solução alternativa**: selecione um tema de design e salve.  <!-- BUNDLE-2623-->

### Vértice

* **Problema**: o aplicativo exibe um  **Verificação de endereço** na seção de envio do fluxo de trabalho de check-out, mesmo quando a validação de endereço estiver desativada. O validador de endereço não verifica novamente o endereço atualizado e continua a exibir uma mensagem que indica que o endereço é inválido quando um cliente insere um endereço correto depois de inserir um endereço incorreto, mesmo quando a validação de endereço está habilitada. **Solução alternativa**: Desativar validação de endereço Vertex. <!-- BUNDLE-2604-->
...
A variável [Kit de ferramentas de migração de código](https://github.com/magento/code-migration) O ajuda a transferir as extensões e personalizações do armazenamento do Magento 1.x existente para o Magento 2.x. A interface de linha de comando inclui scripts para converter módulos e layouts do Magento 1.x.
