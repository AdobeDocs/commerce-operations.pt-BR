...
* [Pagamento do Amazon](https://commercemarketplace.adobe.com//amzn-amazon-pay-magento-2-module.html). O Amazon Pay foi descontinuado e será removido em uma versão 2.4.x posterior. A versão 2.4.3 e superior conterá apenas atualizações para compatibilidade e correções para bugs principais.
...
* A classificação por posição na pesquisa de produtos usando a GET `/rest/V1/products/?searchCriteria[filterGroups]` agora funciona conforme esperado. Anteriormente, a coleção de produtos não tinha um valor de campo `position` para classificação. [GitHub-31591](https://github.com/magento/magento2/issues/31591)
...
* As chamadas de API REST GET Cart agora retornam valores de atributo personalizados corretos para endereços de faturamento e envio. Anteriormente, os atributos de endereço personalizados eram exibidos incorretamente na página de detalhes do pedido na página inicial da loja Minha conta e no Administrador.
...
* O objeto PHP `ArrayIterator` foi atualizado para funcionar como esperado com o PHP 7.4. [GitHub-32088](https://github.com/magento/magento2/issues/32088)
...
* A chamada REST GET `/V1/customers/search` agora retorna informações corretas para clientes que assinaram vários boletins informativos. [GitHub-31168](https://github.com/magento/magento2/issues/31168)
...
* Parâmetros redundantes foram removidos e POST alterado para GET onde necessário em `\Magento\Logging\Model\ProcessorTest::testLoggingProcessorLogsActionShipping`.
