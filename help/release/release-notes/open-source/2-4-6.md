...
**Solução alternativa**: Um hot fix para esse problema está disponível. Ir para [Ferramenta Correções de Qualidade: Pesquisar por patches](https://experienceleague.adobe.com/tools/commerce-quality-patches/index.html) e procure o patch ACSD-50814.
