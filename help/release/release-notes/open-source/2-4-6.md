...
* Adição de texto informativo abaixo do campo de entrada `Storefront Properties` do atributo `Search Weight` em Administrador **[!UICONTROL Stores]** > [!UICONTROL Attributes] > **[!UICONTROL Product]**.
