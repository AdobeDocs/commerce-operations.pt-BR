...
* As navegações estruturais da hierarquia de página do CMS não são mais exibidas quando **[!UICONTROL Enable Hierarchy Functionality]** está desabilitado. Anteriormente, as navegações estruturais eram exibidas e, quando os compradores clicavam nelas, uma página 404 era exibida. [GitHub-35513](https://github.com/magento/magento2/issues/35513)
