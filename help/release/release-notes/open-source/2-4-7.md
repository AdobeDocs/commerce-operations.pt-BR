...
* O texto informativo no campo de entrada `Search Weight` do atributo `Storefront Properties` em Admin **[!UICONTROL Stores]** > **[!UICONTROL Attributes]** > **[!UICONTROL Product]** agora descreve os valores possíveis. [GitHub-36646](https://github.com/magento/magento2/issues/36675)
