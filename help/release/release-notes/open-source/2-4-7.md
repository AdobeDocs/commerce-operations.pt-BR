...
Nossa pilha de tecnologia é criada em PHP e MySQL. Para obter mais informações, consulte [requisitos de sistema](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/system-requirements.html).

## Instruções de instalação e atualização

Você pode instalar o Magento Open Source 2.4.7 usando [o Composer](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/composer.html).
