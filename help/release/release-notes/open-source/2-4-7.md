...
* As APIs REST FedEx do Commerce foram atualizadas para compatibilidade com os serviços Web FedEx atualizados, que serão lançados em maio de 2024. Não há suporte para FedEx SOAP nesta versão. <!-- AC-1470 -->
...
* Os produtos configuráveis com dois produtos secundários não são mais marcados como indisponíveis quando um produto secundário é desativado por uma atualização programada. Este foi um problema conhecido para o 2.4.7-beta1.
