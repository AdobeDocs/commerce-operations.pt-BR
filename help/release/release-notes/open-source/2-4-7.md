---
title: Notas de versão do Magento Open Source 2.4.7-beta3
description: Saiba mais sobre novos recursos, melhorias, correções de bugs e problemas conhecidos na versão 2.4.7-beta3 do Magento Open Source.
...
# Notas de versão do Magento Open Source 2.4.7-beta3
...
Magento Open Source 2.4.7-beta3 apresenta suporte para PHP 8.3. Ele inclui mais de 150 correções e melhorias de qualidade. As dependências do Core Composer e bibliotecas de terceiros foram atualizadas para as versões mais recentes disponíveis.
...
O Magento Open Source 2.4.7-beta3 foi testado com as seguintes versões de componentes:

* Chrome 118
* Composer 2.6 ou a versão mais recente compatível com PHP 8.3
* Elasticsearch 8.11 ou a versão mais recente disponível
* MariaDB 10.6
* MySQL 8.0
* Nginx 1.24
* OpenSearch 2.12
* PHP 8.3 e 8.2
* RabbitMQ 3.13 ou a versão mais recente disponível
* Redis 7.2
* Verniz 7.4.1 ou a versão mais recente disponível
...
## Destaques do Magento Open Source 2.4.7-beta3
...
O Magento Open Source 2.4.7-beta3 inclui as seguintes atualizações de plataforma:
...
O Magento Open Source 2.4.7-beta3 ainda é compatível com o PHP 8.1 apenas para fins de atualização. O PHP 8.1 não é suportado e não é recomendado. O código núcleo do Magento Open Source 2.4.7-beta3, todas as extensões agrupadas e todas as extensões de propriedade do Adobe e serviços SaaS são compatíveis com o PHP 8.3. <!-- AC-9668 -->

* **Suporte ao RabbitMQ 3.11**. Esta versão é compatível com a versão mais recente do RabbitMQ 3.11. A compatibilidade permanece com o RabbitMQ 3.9, que é compatível até agosto de 2023, mas recomendamos usar o Magento Open Source 2.4.7-beta3 somente com o RabbitMQ 3.11.

* **Composer 2.6.x**. A compatibilidade com o Composer 2.2.x permanece. <!-- AC-9663 -->

* **Suporte ao cache vernish 7.4**. Esta versão é compatível com a versão mais recente do Varnish Cache 7.4. A compatibilidade permanece com as versões 6.0.x e 7.2.x, mas recomendamos usar o Magento Open Source 2.4.7-beta3 somente com o Cache de Varnish versão 7.4 ou versão 6.0 LTS. <!-- AC-9662 -->
...
* O gateway da API XML do UPS de comércio foi migrado para a nova API REST do UPS de comércio para oferecer suporte às atualizações que o UPS está fazendo na [Modelo de segurança da API](https://developer.ups.com/oauth-developer-guide). (O UPS está implementando um modelo de segurança OAuth 2.0 (tokens de portador) para todas as APIs.) Todas as APIs XML do Commerce UPS anteriores foram removidas da base de código do Magento Open Source 2.4.7. <!-- AC-8918 -->

* A integração de Magento Open Source com o FedEx foi migrada dos serviços Web WSDL herdados do FedEx para as APIs RESTful mais recentes do FedEx. O WSDLS de Rastreamento de serviços da Web do FedEx, Validação de endereço e Validação de códigos postais será desativado em maio de 2024. <!-- AC-1470 -->
...
O Magento Open Source 2.4.7 inclui recursos aprimorados de cache do GraphQL, suporte ao esquema GraphQL para atributos personalizados, suporte para cancelamento de pedido headless e cqching de resolvedor aprimorado.
...
* `clearCart` mutação <!-- LYNX-254 -->
* `createGuestCart` mutação
...
O Inventory management (v1.2.7-beta3) fornece ferramentas para gerenciar o inventário de produtos. Esse recurso desenvolvido pela comunidade é fornecido com o código principal do Adobe Commerce e do Magento Open Source.

### Metapackage de extensão do Magento Open Source

Esta versão inclui o Magento Open Source Extension metapackage v1.0.0-beta2, que agrupa automaticamente extensões Magento Open Source selecionadas com esta versão principal. A versão desta extensão incluída neste metapackage é instalada quando `composer update` O é executado, simplificando o processo de atualização da extensão ao atualizar para a versão principal mais recente. Essa extensão mantém uma programação de lançamento independente.

O metapackage de extensão do Magento Open Source para o Magento Open Source 2.4.7-beta3 inclui estas extensões:
...
Os seguintes problemas conhecidos serão corrigidos no Adobe Commerce 2.4.7 GA:

**Problema**: serviços nativos AWS Cloud não são compatíveis com o PHP 8.3. A compatibilidade com o PHP 8.3 será introduzida no Adobe Commerce 2.4.7 GA. <!-- AC-11395 -->

**Problema**: as categorias não estão visíveis para os compradores em lojas onde o cache está definido como Fastly CDN (**[!UICONTROL Caching Application=Fastly CDN]**). Isso afeta tanto os compradores convidados quanto os clientes registrados.  <!-- AC-11411 -->

**Problema**: um produto não é removido, conforme esperado, do minicarrinho depois que o catálogo compartilhado atribuído a ele é removido do produto. <!-- AC-8935 -->
...
Você pode instalar o Magento Open Source 2.4.7-beta3 usando [Compositor](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/composer.html).
