...
* Agora você pode renomear um patch de dados e adicionar o nome de classe antigo como um alias na variável `patch_list` tabela de banco de dados. {{ site.data.var.Ce }} agora verifica se aliases de patch de dados já existiam no banco de dados antes de aplicar o patch. Anteriormente, o applicationOpen Source gerava um erro sob essas condições.
