...
* As dependências da biblioteca Laminas foram atualizadas para versões compatíveis com o PHP 8.x. Algumas dependências redundantes foram removidas do arquivo `composer.json`. **Magento Open Source 2.4.3 usa Laminas 3.4.0**. <!-- MC-39513-->
