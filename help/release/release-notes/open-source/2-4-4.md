...
* O HTTPS agora está ativado por padrão para a loja da Magento Open Source. As configurações **Usar URLs Seguras na Loja** e **Usar URLs Seguras no Administrador** estão habilitadas por padrão, e todos os cookies internos agora estão definidos como seguros.  <!-- AC-1173-->
...
* Os desenvolvedores agora podem configurar o limite de tamanho de arrays aceitos pelos endpoints RESTful da Magento Open Source com base no endpoint. Consulte [Segurança de API](https://developer.adobe.com/commerce/webapi/get-started/api-security/). <!-- AC-465-->
...
* O método `str_contains` sem suporte foi substituído por uma função com suporte. Esse era um problema conhecido do Magento Open Source 2.4.3. [GitHub-33680](https://github.com/magento/magento2/issues/33680)
...
Consulte [Dotdigital — Automação de Marketing](https://commercemarketplace.adobe.com//dotdigital-dotdigital-magento2-os-package.html) para obter informações de compra e download.
