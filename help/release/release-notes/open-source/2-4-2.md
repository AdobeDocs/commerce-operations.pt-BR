...
* Os valores de cabeçalho que incluem URLs agora são analisados corretamente no `ApiFunctional TestFramework`. [GitHub-26425](https://github.com/magento/magento2/issues/26425)
...
Você pode instalar o Magento Open Source 2.4.2 usando [Compositor](../../../installation/composer.md).
