...
O Magento Open Source 2.4.2 traz aperfeiçoamentos ao desempenho e à segurança além de melhorias significativas na plataforma. Os aprimoramentos de segurança incluem a expansão do suporte para o atributo `SameSite` para todos os cookies. Elasticsearch 7.9.x e Redis 6.x agora são suportados.
