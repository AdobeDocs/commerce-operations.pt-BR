...
* O resolvedor de URL GraphQL agora lida com os parâmetros de consulta corretamente. Anteriormente, retornava NULL ao manipular URLs compatíveis com SEO com parâmetros.

<!-- ENGCOM-8422 -->

* O resolvedor de URL GraphQL agora lida com a hierarquia de página do CMS corretamente. Anteriormente, retornava NULL. [GitHub-30474](https://github.com/magento/magento2/issues/30474)
...
* O aplicativo agora retorna uma mensagem mais informativa quando ocorre um erro durante uma operação de redefinição de senha GraphQL. [GitHub-30179](https://github.com/magento/magento2/issues/30179)

<!-- MC-38078-->

* As posições dos produtos agora são atualizadas conforme esperado nos resultados da consulta GraphQL quando os resultados da consulta são armazenados em cache.
