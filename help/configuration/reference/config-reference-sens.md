...
| ID de logon da API | `payment_nz/authorizenet_directpost/login` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> | !![Commerce-only]([enc] |  | ![Sensível](/help/assets/configuration/cloud-sens.png) |
