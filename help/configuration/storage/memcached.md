...
description: Saiba como configurar o Adobe Commerce para usar o memcached para armazenamento de sessão em env.php e quando preferir Redis ou Varnish para outras camadas de cache.
