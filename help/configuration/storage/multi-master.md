...
description: Saiba mais sobre a solução de desempenho de banco de dados dividido para o Adobe Commerce, separando check-out, pedidos e produtos mestres para escalabilidade local.
