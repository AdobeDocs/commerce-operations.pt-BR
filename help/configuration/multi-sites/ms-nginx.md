...
1. Passe os valores das [variáveis MAGE](ms-overview.md) `$MAGE_RUN_TYPE` e `$MAGE_RUN_CODE` para nginx usando o `nginx.conf.sample` fornecido pela Magento (etapas detalhadas abaixo).
