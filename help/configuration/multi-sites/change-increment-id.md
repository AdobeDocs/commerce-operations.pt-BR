...
description: Saiba como alterar IDs de incremento para pedidos, faturas, avisos de crédito e outras entidades de banco de dados do Commerce usando SQL ao mesclar ou restaurar sites.
