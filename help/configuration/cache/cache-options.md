...
>[!NOTE]
>
>O nome de tipo `redis` também é aceito, mas Redis não é um serviço de cache oficialmente compatível com o Adobe Commerce 2.4.9 e posterior. Em vez disso, use `valkey`.
