...
+ Cache {#cache}
   ...
   + Redis {#redis}
      + [Instalar e configurar o Redis](cache/config-redis.md)
      + [Configurar Redis para cache padrão e de páginas](cache/redis-pg-cache.md)
      + [Configurar Redis para armazenamento de sessão](cache/redis-session.md)
      + [Configurar o Redis com o AWS ElastiCache](cache/redis-elasticache-for-ec2.md)
   + Valkey {#valkey}
      + [Instalar e configurar o Valkey](cache/config-valkey.md)
      + [Configurar Valkey para cache padrão e de página](cache/valkey-pg-cache.md)
      + [Configurar Valkey para armazenamento de sessão](cache/valkey-session.md)
   + Verniz {#varnish}
      + [Visão geral do verniz](cache/config-varnish.md)
      + [Instalar verniz](cache/config-varnish-install.md)
      + [Configurar o servidor Web](cache/config-varnish-server.md)
      ...
      + [Limpeza de cache com verniz](cache/use-varnish-cache.md)
      + [Limpeza de cache com várias instâncias de verniz](cache/use-multiple-varnish-cache.md)
