...
>
>Consulte [Práticas recomendadas para a configuração de indexador](/help/implementation-playbook/best-practices/maintenance/indexer-configuration.md) no _Manual de implementação_.
