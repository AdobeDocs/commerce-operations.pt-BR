...
Este projeto adotou o [Código de Conduta de Origem Aberta do Adobe](code-of-conduct.md) ou o [.NET Foundation Code of Conduta](https://dotnetfoundation.org/code-of-conduct). Para obter mais informações, consulte o artigo [Contribuição](contributing.md) .
