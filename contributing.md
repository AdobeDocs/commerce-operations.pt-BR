...
Este projeto adere ao Adobe [código de conduta](code-of-conduct.md). Ao participar, você deve seguir esse código. Denuncie comportamento inaceitável para
...
Todos os envios devem vir na forma de solicitações pull e precisam ser revisados pelos confirmadores do projeto. Ler [Documentação de solicitação de pull do GitHub](https://help.github.com/articles/about-pull-requests/)
